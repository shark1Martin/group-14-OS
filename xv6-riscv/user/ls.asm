...
ls(char *path)
{
  ...
  f4:	a7050513          	addi	a0,a0,-1424 # b60 <malloc+0x12c>
  f8:	085000ef          	jal	97c <printf>
      }
 ...
 11e:	a1658593          	addi	a1,a1,-1514 # b30 <malloc+0xfc>
 122:	4509                	li	a0,2
 124:	02f000ef          	jal	952 <fprintf>
    return;
 128:	bff9                	j	106 <ls+0x6e>
    fprintf(2, "ls: cannot stat %s\n", path);
 12a:	864a                	mv	a2,s2
 12c:	00001597          	auipc	a1,0x1
 130:	a1c58593          	addi	a1,a1,-1508 # b48 <malloc+0x114>
 134:	4509                	li	a0,2
 136:	01d000ef          	jal	952 <fprintf>
    close(fd);
 13a:	8526                	mv	a0,s1
 ...
 15a:	a1a50513          	addi	a0,a0,-1510 # b70 <malloc+0x13c>
 15e:	01f000ef          	jal	97c <printf>
      break;
 ...
 1a0:	9ac50513          	addi	a0,a0,-1620 # b48 <malloc+0x114>
 1a4:	7d8000ef          	jal	97c <printf>
    while(read(fd, &de, sizeof(de)) == sizeof(de)){
 1a8:	4641                	li	a2,16
 ...
 1fa:	96a50513          	addi	a0,a0,-1686 # b60 <malloc+0x12c>
 1fe:	77e000ef          	jal	97c <printf>
...
main(int argc, char *argv[])
{
 ...
 24a:	94250513          	addi	a0,a0,-1726 # b88 <malloc+0x154>
...
00000000000005ce <check_deadlock>:
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 600:	892a                	mv	s2,a0
  ...
  neg = 0;
  if(sgn && xx < 0){
 602:	c6d1                	beqz	a3,68e <printint+0x9a>
 604:	0805d563          	bgez	a1,68e <printint+0x9a>
    neg = 1;
    x = -xx;
 ...
 61a:	58280813          	addi	a6,a6,1410 # b98 <digits>
 61e:	88ba                	mv	a7,a4
 620:	0017051b          	addiw	a0,a4,1
 624:	872a                	mv	a4,a0
 626:	02c5f7b3          	remu	a5,a1,a2
 ...
 63c:	fec7f1e3          	bgeu	a5,a2,61e <printint+0x2a>
  if(neg)
 640:	00030c63          	beqz	t1,658 <printint+0x64>
    buf[i++] = '-';
 644:	fd050793          	addi	a5,a0,-48
 648:	00878533          	add	a0,a5,s0
 64c:	02d00793          	li	a5,45
 650:	fef50423          	sb	a5,-24(a0)
 654:	0028871b          	addiw	a4,a7,2

  while(--i >= 0)
 658:	02e05563          	blez	a4,682 <printint+0x8e>
 65c:	fc26                	sd	s1,56(sp)
 65e:	377d                	addiw	a4,a4,-1
 660:	00e984b3          	add	s1,s3,a4
 664:	19fd                	addi	s3,s3,-1
 ...
 674:	854a                	mv	a0,s2
 676:	f61ff0ef          	jal	5d6 <putc>
  while(--i >= 0)
 67a:	14fd                	addi	s1,s1,-1
 67c:	ff349ae3          	bne	s1,s3,670 <printint+0x7c>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6a0:	22048363          	beqz	s1,8c6 <vprintf+0x234>
 ...
 6c6:	a00d                	j	6e8 <vprintf+0x56>
        putc(fd, c0);
 6c8:	85a6                	mv	a1,s1
 6ca:	855a                	mv	a0,s6
 6cc:	f0bff0ef          	jal	5d6 <putc>
 6d0:	a019                	j	6d6 <vprintf+0x44>
    } else if(state == '%'){
 6d2:	03598363          	beq	s3,s5,6f8 <vprintf+0x66>
  for(i = 0; fmt[i]; i++){
 6d6:	0019079b          	addiw	a5,s2,1
 6da:	893e                	mv	s2,a5
 6dc:	873e                	mv	a4,a5
 6de:	97d2                	add	a5,a5,s4
 6e0:	0007c483          	lbu	s1,0(a5)
 6e4:	1c048a63          	beqz	s1,8b8 <vprintf+0x226>
    c0 = fmt[i] & 0xff;
 6e8:	0004879b          	sext.w	a5,s1
    if(state == 0){
 6ec:	fe0993e3          	bnez	s3,6d2 <vprintf+0x40>
      if(c0 == '%'){
 6f0:	fd579ce3          	bne	a5,s5,6c8 <vprintf+0x36>
        state = '%';
 6f4:	89be                	mv	s3,a5
 6f6:	b7c5                	j	6d6 <vprintf+0x44>
      if(c0) c1 = fmt[i+1] & 0xff;
 6f8:	00ea06b3          	add	a3,s4,a4
 6fc:	0016c603          	lbu	a2,1(a3)
      if(c1) c2 = fmt[i+2] & 0xff;
 700:	1c060863          	beqz	a2,8d0 <vprintf+0x23e>
      if(c0 == 'd'){
 704:	03878763          	beq	a5,s8,732 <vprintf+0xa0>
        printint(fd, va_arg(ap, int), 10, 1);
      } else if(c0 == 'l' && c1 == 'd'){
 708:	f9478693          	addi	a3,a5,-108
 70c:	0016b693          	seqz	a3,a3
 710:	f9c60593          	addi	a1,a2,-100
 714:	e99d                	bnez	a1,74a <vprintf+0xb8>
 716:	ca95                	beqz	a3,74a <vprintf+0xb8>
 ...
 724:	855a                	mv	a0,s6
 726:	ecfff0ef          	jal	5f4 <printint>
        i += 1;
 72a:	2905                	addiw	s2,s2,1
        printint(fd, va_arg(ap, uint64), 10, 1);
 72c:	8ba6                	mv	s7,s1
 ...
 73e:	855a                	mv	a0,s6
 740:	eb5ff0ef          	jal	5f4 <printint>
 744:	8ba6                	mv	s7,s1
      state = 0;
 746:	4981                	li	s3,0
 748:	b779                	j	6d6 <vprintf+0x44>
      if(c1) c2 = fmt[i+2] & 0xff;
 74a:	9752                	add	a4,a4,s4
 74c:	00274583          	lbu	a1,2(a4)
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
 750:	f9460713          	addi	a4,a2,-108
 754:	00173713          	seqz	a4,a4
 758:	8f75                	and	a4,a4,a3
 75a:	f9c58513          	addi	a0,a1,-100
 75e:	18051363          	bnez	a0,8e4 <vprintf+0x252>
 762:	18070163          	beqz	a4,8e4 <vprintf+0x252>
        printint(fd, va_arg(ap, uint64), 10, 1);
 ...
 78c:	855a                	mv	a0,s6
 78e:	e67ff0ef          	jal	5f4 <printint>
 792:	8ba6                	mv	s7,s1
      state = 0;
 794:	4981                	li	s3,0
 796:	b781                	j	6d6 <vprintf+0x44>
 ...
 814:	4981                	li	s3,0
        i += 2;
 816:	b5c1                	j	6d6 <vprintf+0x44>
 818:	e466                	sd	s9,8(sp)
        printptr(fd, va_arg(ap, uint64));
 81a:	008b8793          	addi	a5,s7,8
 81e:	8cbe                	mv	s9,a5
 820:	000bb983          	ld	s3,0(s7)
  putc(fd, '0');
 824:	03000593          	li	a1,48
 828:	855a                	mv	a0,s6
 82a:	dadff0ef          	jal	5d6 <putc>
  putc(fd, 'x');
 82e:	07800593          	li	a1,120
 832:	855a                	mv	a0,s6
 834:	da3ff0ef          	jal	5d6 <putc>
 838:	44c1                	li	s1,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
 83a:	00000b97          	auipc	s7,0x0
 83e:	35eb8b93          	addi	s7,s7,862 # b98 <digits>
 842:	03c9d793          	srli	a5,s3,0x3c
 846:	97de                	add	a5,a5,s7
 848:	0007c583          	lbu	a1,0(a5)
 84c:	855a                	mv	a0,s6
 84e:	d89ff0ef          	jal	5d6 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
 852:	0992                	slli	s3,s3,0x4
 854:	34fd                	addiw	s1,s1,-1
 856:	f4f5                	bnez	s1,842 <vprintf+0x1b0>
        printptr(fd, va_arg(ap, uint64));
 858:	8be6                	mv	s7,s9
      state = 0;
 85a:	4981                	li	s3,0
 85c:	6ca2                	ld	s9,8(sp)
 85e:	bda5                	j	6d6 <vprintf+0x44>
        putc(fd, va_arg(ap, uint32));
 860:	008b8493          	addi	s1,s7,8
 864:	000bc583          	lbu	a1,0(s7)
 868:	855a                	mv	a0,s6
 86a:	d6dff0ef          	jal	5d6 <putc>
 86e:	8ba6                	mv	s7,s1
      state = 0;
 870:	4981                	li	s3,0
 872:	b595                	j	6d6 <vprintf+0x44>
        if((s = va_arg(ap, char*)) == 0)
 874:	008b8993          	addi	s3,s7,8
 878:	000bb483          	ld	s1,0(s7)
 87c:	cc91                	beqz	s1,898 <vprintf+0x206>
        for(; *s; s++)
 87e:	0004c583          	lbu	a1,0(s1)
 882:	c985                	beqz	a1,8b2 <vprintf+0x220>
          putc(fd, *s);
 884:	855a                	mv	a0,s6
 ...
 890:	f9f5                	bnez	a1,884 <vprintf+0x1f2>
        if((s = va_arg(ap, char*)) == 0)
 892:	8bce                	mv	s7,s3
      state = 0;
 894:	4981                	li	s3,0
 896:	b581                	j	6d6 <vprintf+0x44>
          s = "(null)";
 898:	00000497          	auipc	s1,0x0
 89c:	2f848493          	addi	s1,s1,760 # b90 <malloc+0x15c>
        for(; *s; s++)
 8a0:	02800593          	li	a1,40
 8a4:	b7c5                	j	884 <vprintf+0x1f2>
        putc(fd, '%');
 8a6:	85be                	mv	a1,a5
 8a8:	855a                	mv	a0,s6
 8aa:	d2dff0ef          	jal	5d6 <putc>
      state = 0;
 8ae:	4981                	li	s3,0
 8b0:	b51d                	j	6d6 <vprintf+0x44>
        if((s = va_arg(ap, char*)) == 0)
 8b2:	8bce                	mv	s7,s3
      state = 0;
 8b4:	4981                	li	s3,0
 8b6:	b505                	j	6d6 <vprintf+0x44>
 ...
 8ce:	8082                	ret
      if(c0 == 'd'){
 8d0:	06400713          	li	a4,100
 8d4:	e4e78fe3          	beq	a5,a4,732 <vprintf+0xa0>
      } else if(c0 == 'l' && c1 == 'd'){
 8d8:	f9478693          	addi	a3,a5,-108
 8dc:	0016b693          	seqz	a3,a3
      c1 = c2 = 0;
 8e0:	85b2                	mv	a1,a2
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
 8e2:	4701                	li	a4,0
      } else if(c0 == 'u'){
 8e4:	07500513          	li	a0,117
 8e8:	e8a78ce3          	beq	a5,a0,780 <vprintf+0xee>
      } else if(c0 == 'l' && c1 == 'u'){
 8ec:	f8b60513          	addi	a0,a2,-117
 8f0:	e119                	bnez	a0,8f6 <vprintf+0x264>
 8f2:	ea0693e3          	bnez	a3,798 <vprintf+0x106>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
 8f6:	f8b58513          	addi	a0,a1,-117
 8fa:	e119                	bnez	a0,900 <vprintf+0x26e>
 8fc:	ea071be3          	bnez	a4,7b2 <vprintf+0x120>
      } else if(c0 == 'x'){
 900:	07800513          	li	a0,120
 904:	eca784e3          	beq	a5,a0,7cc <vprintf+0x13a>
      } else if(c0 == 'l' && c1 == 'x'){
 908:	f8860613          	addi	a2,a2,-120
 90c:	e219                	bnez	a2,912 <vprintf+0x280>
 90e:	ec069be3          	bnez	a3,7e4 <vprintf+0x152>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'x'){
 912:	f8858593          	addi	a1,a1,-120
 916:	e199                	bnez	a1,91c <vprintf+0x28a>
 918:	ee0713e3          	bnez	a4,7fe <vprintf+0x16c>
      } else if(c0 == 'p'){
 91c:	07000713          	li	a4,112
 920:	eee78ce3          	beq	a5,a4,818 <vprintf+0x186>
      } else if(c0 == 'c'){
 924:	06300713          	li	a4,99
 928:	f2e78ce3          	beq	a5,a4,860 <vprintf+0x1ce>
      } else if(c0 == 's'){
 92c:	07300713          	li	a4,115
 930:	f4e782e3          	beq	a5,a4,874 <vprintf+0x1e2>
      } else if(c0 == '%'){
 934:	02500713          	li	a4,37
 938:	f6e787e3          	beq	a5,a4,8a6 <vprintf+0x214>
        putc(fd, '%');
 93c:	02500593          	li	a1,37
 940:	855a                	mv	a0,s6
 942:	c95ff0ef          	jal	5d6 <putc>
        putc(fd, c0);
 946:	85a6                	mv	a1,s1
 948:	855a                	mv	a0,s6
 94a:	c8dff0ef          	jal	5d6 <putc>
      state = 0;
 94e:	4981                	li	s3,0
 950:	b359                	j	6d6 <vprintf+0x44>
...
free(void *ap)
{
 ...
 9be:	6467b783          	ld	a5,1606(a5) # 1000 <freep>
 9c2:	a039                	j	9d0 <free+0x22>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
 9c4:	6398                	ld	a4,0(a5)
 9c6:	00e7e463          	bltu	a5,a4,9ce <free+0x20>
 9ca:	00e6ea63          	bltu	a3,a4,9de <free+0x30>
{
 9ce:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
 9d0:	fed7fae3          	bgeu	a5,a3,9c4 <free+0x16>
 9d4:	6398                	ld	a4,0(a5)
 9d6:	00e6e463          	bltu	a3,a4,9de <free+0x30>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
 9da:	fee7eae3          	bltu	a5,a4,9ce <free+0x20>
      break;
 ...
 9ee:	02e60563          	beq	a2,a4,a18 <free+0x6a>
 ...
 a02:	02e68263          	beq	a3,a4,a26 <free+0x78>
    p->s.size += bp->s.size;
    p->s.ptr = bp->s.ptr;
 a06:	e394                	sd	a3,0(a5)
  } else
...
malloc(uint nbytes)
{
 ...
 a40:	02051993          	slli	s3,a0,0x20
 a44:	0209d993          	srli	s3,s3,0x20
 a48:	09bd                	addi	s3,s3,15
 a4a:	0049d993          	srli	s3,s3,0x4
 a4e:	2985                	addiw	s3,s3,1
 a50:	894e                	mv	s2,s3
  if((prevp = freep) == 0){
 a52:	00000517          	auipc	a0,0x0
 a56:	5ae53503          	ld	a0,1454(a0) # 1000 <freep>
 a5a:	c905                	beqz	a0,a8a <malloc+0x56>
 ...
 a5c:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
 a5e:	4798                	lw	a4,8(a5)
 a60:	09377663          	bgeu	a4,s3,aec <malloc+0xb8>
 ...
 a6c:	8a4e                	mv	s4,s3
 a6e:	6705                	lui	a4,0x1
 a70:	00e9f363          	bgeu	s3,a4,a76 <malloc+0x42>
 a74:	6a05                	lui	s4,0x1
 ...
 a82:	58248493          	addi	s1,s1,1410 # 1000 <freep>
  if(p == SBRK_ERROR)
 a86:	5afd                	li	s5,-1
 a88:	a83d                	j	ac6 <malloc+0x92>
 ...
 a96:	58e78793          	addi	a5,a5,1422 # 1020 <base>
 a9a:	00000717          	auipc	a4,0x0
 a9e:	56f73323          	sd	a5,1382(a4) # 1000 <freep>
 aa2:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 aa4:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
 aa8:	b7d1                	j	a6c <malloc+0x38>
        prevp->s.ptr = p->s.ptr;
 aaa:	6398                	ld	a4,0(a5)
 aac:	e118                	sd	a4,0(a0)
 aae:	a899                	j	b04 <malloc+0xd0>
  hp->s.size = nu;
 ab0:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
 ab4:	0541                	addi	a0,a0,16
 ab6:	ef9ff0ef          	jal	9ae <free>
  return freep;
 aba:	6088                	ld	a0,0(s1)
      if((p = morecore(nunits)) == 0)
 abc:	c125                	beqz	a0,b1c <malloc+0xe8>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 abe:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
 ac0:	4798                	lw	a4,8(a5)
 ac2:	03277163          	bgeu	a4,s2,ae4 <malloc+0xb0>
    if(p == freep)
 ac6:	6098                	ld	a4,0(s1)
 ac8:	853e                	mv	a0,a5
 aca:	fef71ae3          	bne	a4,a5,abe <malloc+0x8a>
  p = sbrk(nu * sizeof(Header));
 ace:	8552                	mv	a0,s4
 ad0:	a0bff0ef          	jal	4da <sbrk>
  if(p == SBRK_ERROR)
 ad4:	fd551ee3          	bne	a0,s5,ab0 <malloc+0x7c>
        return 0;
 ad8:	4501                	li	a0,0
 ...
 ade:	6aa2                	ld	s5,8(sp)
 ae0:	6b02                	ld	s6,0(sp)
 ae2:	a03d                	j	b10 <malloc+0xdc>
 ae4:	74a2                	ld	s1,40(sp)
 ae6:	6a42                	ld	s4,16(sp)
 ae8:	6aa2                	ld	s5,8(sp)
 aea:	6b02                	ld	s6,0(sp)
      if(p->s.size == nunits)
 aec:	fae90fe3          	beq	s2,a4,aaa <malloc+0x76>
        p->s.size -= nunits;
 ...
 b08:	4ea73e23          	sd	a0,1276(a4) # 1000 <freep>
      return (void*)(p + 1);

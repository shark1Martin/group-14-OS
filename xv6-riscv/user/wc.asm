...
wc(int fd, char *name)
{
  ...
  40:	9f4a0a13          	addi	s4,s4,-1548 # a30 <malloc+0xf8>
  while((n = read(fd, buf, sizeof(buf))) > 0){
  ...
  a2:	9b250513          	addi	a0,a0,-1614 # a50 <malloc+0x118>
  a6:	7da000ef          	jal	880 <printf>
}
  ...
  cc:	97850513          	addi	a0,a0,-1672 # a40 <malloc+0x108>
  d0:	7b0000ef          	jal	880 <printf>
    exit(1);
  d4:	4505                	li	a0,1
...
main(int argc, char *argv[])
{
 ...
 136:	90658593          	addi	a1,a1,-1786 # a38 <malloc+0x100>
 13a:	4501                	li	a0,0
 ...
 14e:	91650513          	addi	a0,a0,-1770 # a60 <malloc+0x128>
 152:	72e000ef          	jal	880 <printf>
      exit(1);
 156:	4505                	li	a0,1
...
00000000000004d2 <check_deadlock>:
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 504:	892a                	mv	s2,a0
  ...
  neg = 0;
  if(sgn && xx < 0){
 506:	c6d1                	beqz	a3,592 <printint+0x9a>
 508:	0805d563          	bgez	a1,592 <printint+0x9a>
    neg = 1;
    x = -xx;
 ...
 51e:	56680813          	addi	a6,a6,1382 # a80 <digits>
 522:	88ba                	mv	a7,a4
 524:	0017051b          	addiw	a0,a4,1
 528:	872a                	mv	a4,a0
 52a:	02c5f7b3          	remu	a5,a1,a2
 52e:	97c2                	add	a5,a5,a6
 ...
 540:	fec7f1e3          	bgeu	a5,a2,522 <printint+0x2a>
  if(neg)
 544:	00030c63          	beqz	t1,55c <printint+0x64>
    buf[i++] = '-';
 548:	fd050793          	addi	a5,a0,-48
 54c:	00878533          	add	a0,a5,s0
 550:	02d00793          	li	a5,45
 554:	fef50423          	sb	a5,-24(a0)
 558:	0028871b          	addiw	a4,a7,2

  while(--i >= 0)
 55c:	02e05563          	blez	a4,586 <printint+0x8e>
 560:	fc26                	sd	s1,56(sp)
 562:	377d                	addiw	a4,a4,-1
 564:	00e984b3          	add	s1,s3,a4
 568:	19fd                	addi	s3,s3,-1
 56a:	99ba                	add	s3,s3,a4
 56c:	1702                	slli	a4,a4,0x20
 56e:	9301                	srli	a4,a4,0x20
 570:	40e989b3          	sub	s3,s3,a4
    putc(fd, buf[i]);
 574:	0004c583          	lbu	a1,0(s1)
 578:	854a                	mv	a0,s2
 57a:	f61ff0ef          	jal	4da <putc>
  while(--i >= 0)
 57e:	14fd                	addi	s1,s1,-1
 580:	ff349ae3          	bne	s1,s3,574 <printint+0x7c>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 59e:	1080                	addi	s0,sp,96
  ...
  state = 0;
  for(i = 0; fmt[i]; i++){
 5a0:	0005c483          	lbu	s1,0(a1)
 5a4:	22048363          	beqz	s1,7ca <vprintf+0x234>
 ...
 5ca:	a00d                	j	5ec <vprintf+0x56>
        putc(fd, c0);
 5cc:	85a6                	mv	a1,s1
 5ce:	855a                	mv	a0,s6
 5d0:	f0bff0ef          	jal	4da <putc>
 5d4:	a019                	j	5da <vprintf+0x44>
    } else if(state == '%'){
 5d6:	03598363          	beq	s3,s5,5fc <vprintf+0x66>
  for(i = 0; fmt[i]; i++){
 5da:	0019079b          	addiw	a5,s2,1
 5de:	893e                	mv	s2,a5
 5e0:	873e                	mv	a4,a5
 5e2:	97d2                	add	a5,a5,s4
 5e4:	0007c483          	lbu	s1,0(a5)
 5e8:	1c048a63          	beqz	s1,7bc <vprintf+0x226>
    c0 = fmt[i] & 0xff;
 5ec:	0004879b          	sext.w	a5,s1
    if(state == 0){
 5f0:	fe0993e3          	bnez	s3,5d6 <vprintf+0x40>
      if(c0 == '%'){
 5f4:	fd579ce3          	bne	a5,s5,5cc <vprintf+0x36>
        state = '%';
 5f8:	89be                	mv	s3,a5
 5fa:	b7c5                	j	5da <vprintf+0x44>
      if(c0) c1 = fmt[i+1] & 0xff;
 5fc:	00ea06b3          	add	a3,s4,a4
 600:	0016c603          	lbu	a2,1(a3)
      if(c1) c2 = fmt[i+2] & 0xff;
 604:	1c060863          	beqz	a2,7d4 <vprintf+0x23e>
      if(c0 == 'd'){
 608:	03878763          	beq	a5,s8,636 <vprintf+0xa0>
        printint(fd, va_arg(ap, int), 10, 1);
      } else if(c0 == 'l' && c1 == 'd'){
 60c:	f9478693          	addi	a3,a5,-108
 610:	0016b693          	seqz	a3,a3
 614:	f9c60593          	addi	a1,a2,-100
 618:	e99d                	bnez	a1,64e <vprintf+0xb8>
 61a:	ca95                	beqz	a3,64e <vprintf+0xb8>
 ...
 642:	855a                	mv	a0,s6
 644:	eb5ff0ef          	jal	4f8 <printint>
 648:	8ba6                	mv	s7,s1
      state = 0;
 64a:	4981                	li	s3,0
 64c:	b779                	j	5da <vprintf+0x44>
      if(c1) c2 = fmt[i+2] & 0xff;
 64e:	9752                	add	a4,a4,s4
 650:	00274583          	lbu	a1,2(a4)
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
 654:	f9460713          	addi	a4,a2,-108
 658:	00173713          	seqz	a4,a4
 65c:	8f75                	and	a4,a4,a3
 65e:	f9c58513          	addi	a0,a1,-100
 662:	18051363          	bnez	a0,7e8 <vprintf+0x252>
 666:	18070163          	beqz	a4,7e8 <vprintf+0x252>
        printint(fd, va_arg(ap, uint64), 10, 1);
 ...
 690:	855a                	mv	a0,s6
 692:	e67ff0ef          	jal	4f8 <printint>
 696:	8ba6                	mv	s7,s1
      state = 0;
 698:	4981                	li	s3,0
 69a:	b781                	j	5da <vprintf+0x44>
 ...
 794:	f9f5                	bnez	a1,788 <vprintf+0x1f2>
        if((s = va_arg(ap, char*)) == 0)
 796:	8bce                	mv	s7,s3
      state = 0;
 798:	4981                	li	s3,0
 79a:	b581                	j	5da <vprintf+0x44>
          s = "(null)";
 79c:	00000497          	auipc	s1,0x0
 7a0:	2dc48493          	addi	s1,s1,732 # a78 <malloc+0x140>
        for(; *s; s++)
 7a4:	02800593          	li	a1,40
 7a8:	b7c5                	j	788 <vprintf+0x1f2>
        putc(fd, '%');
 7aa:	85be                	mv	a1,a5
 7ac:	855a                	mv	a0,s6
 7ae:	d2dff0ef          	jal	4da <putc>
      state = 0;
 7b2:	4981                	li	s3,0
 7b4:	b51d                	j	5da <vprintf+0x44>
        if((s = va_arg(ap, char*)) == 0)
 7b6:	8bce                	mv	s7,s3
      state = 0;
 7b8:	4981                	li	s3,0
 7ba:	b505                	j	5da <vprintf+0x44>
 ...
 7d2:	8082                	ret
      if(c0 == 'd'){
 7d4:	06400713          	li	a4,100
 7d8:	e4e78fe3          	beq	a5,a4,636 <vprintf+0xa0>
      } else if(c0 == 'l' && c1 == 'd'){
 7dc:	f9478693          	addi	a3,a5,-108
 7e0:	0016b693          	seqz	a3,a3
      c1 = c2 = 0;
 7e4:	85b2                	mv	a1,a2
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
 7e6:	4701                	li	a4,0
      } else if(c0 == 'u'){
 7e8:	07500513          	li	a0,117
 7ec:	e8a78ce3          	beq	a5,a0,684 <vprintf+0xee>
      } else if(c0 == 'l' && c1 == 'u'){
 7f0:	f8b60513          	addi	a0,a2,-117
 7f4:	e119                	bnez	a0,7fa <vprintf+0x264>
 7f6:	ea0693e3          	bnez	a3,69c <vprintf+0x106>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
 7fa:	f8b58513          	addi	a0,a1,-117
 7fe:	e119                	bnez	a0,804 <vprintf+0x26e>
 800:	ea071be3          	bnez	a4,6b6 <vprintf+0x120>
      } else if(c0 == 'x'){
 804:	07800513          	li	a0,120
 808:	eca784e3          	beq	a5,a0,6d0 <vprintf+0x13a>
      } else if(c0 == 'l' && c1 == 'x'){
 80c:	f8860613          	addi	a2,a2,-120
 810:	e219                	bnez	a2,816 <vprintf+0x280>
 812:	ec069be3          	bnez	a3,6e8 <vprintf+0x152>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'x'){
 816:	f8858593          	addi	a1,a1,-120
 81a:	e199                	bnez	a1,820 <vprintf+0x28a>
 81c:	ee0713e3          	bnez	a4,702 <vprintf+0x16c>
      } else if(c0 == 'p'){
 820:	07000713          	li	a4,112
 824:	eee78ce3          	beq	a5,a4,71c <vprintf+0x186>
      } else if(c0 == 'c'){
 828:	06300713          	li	a4,99
 82c:	f2e78ce3          	beq	a5,a4,764 <vprintf+0x1ce>
      } else if(c0 == 's'){
 830:	07300713          	li	a4,115
 834:	f4e782e3          	beq	a5,a4,778 <vprintf+0x1e2>
      } else if(c0 == '%'){
 838:	02500713          	li	a4,37
 83c:	f6e787e3          	beq	a5,a4,7aa <vprintf+0x214>
        putc(fd, '%');
 840:	02500593          	li	a1,37
 844:	855a                	mv	a0,s6
 846:	c95ff0ef          	jal	4da <putc>
        putc(fd, c0);
 84a:	85a6                	mv	a1,s1
 84c:	855a                	mv	a0,s6
 84e:	c8dff0ef          	jal	4da <putc>
      state = 0;
 852:	4981                	li	s3,0
 854:	b359                	j	5da <vprintf+0x44>
...
malloc(uint nbytes)
{
 ...
 960:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
 962:	4798                	lw	a4,8(a5)
 964:	09377663          	bgeu	a4,s3,9f0 <malloc+0xb8>
 ...
 986:	67e48493          	addi	s1,s1,1662 # 1000 <freep>
  if(p == SBRK_ERROR)
 98a:	5afd                	li	s5,-1
 98c:	a83d                	j	9ca <malloc+0x92>
 ...
 99a:	87a78793          	addi	a5,a5,-1926 # 1210 <base>
 ...
 9ae:	6398                	ld	a4,0(a5)
 9b0:	e118                	sd	a4,0(a0)
 9b2:	a899                	j	a08 <malloc+0xd0>
  hp->s.size = nu;
 9b4:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
 9b8:	0541                	addi	a0,a0,16
 9ba:	ef9ff0ef          	jal	8b2 <free>
  return freep;
 9be:	6088                	ld	a0,0(s1)
      if((p = morecore(nunits)) == 0)
 9c0:	c125                	beqz	a0,a20 <malloc+0xe8>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 9c2:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
 9c4:	4798                	lw	a4,8(a5)
 9c6:	03277163          	bgeu	a4,s2,9e8 <malloc+0xb0>
    if(p == freep)
 9ca:	6098                	ld	a4,0(s1)
 9cc:	853e                	mv	a0,a5
 9ce:	fef71ae3          	bne	a4,a5,9c2 <malloc+0x8a>
  p = sbrk(nu * sizeof(Header));
 9d2:	8552                	mv	a0,s4
 9d4:	a0bff0ef          	jal	3de <sbrk>
  if(p == SBRK_ERROR)
 9d8:	fd551ee3          	bne	a0,s5,9b4 <malloc+0x7c>
        return 0;
 9dc:	4501                	li	a0,0
 ...
 9e2:	6aa2                	ld	s5,8(sp)
 9e4:	6b02                	ld	s6,0(sp)
 9e6:	a03d                	j	a14 <malloc+0xdc>
 9e8:	74a2                	ld	s1,40(sp)
 9ea:	6a42                	ld	s4,16(sp)
 9ec:	6aa2                	ld	s5,8(sp)
 9ee:	6b02                	ld	s6,0(sp)
      if(p->s.size == nunits)
 9f0:	fae90fe3          	beq	s2,a4,9ae <malloc+0x76>
        p->s.size -= nunits;

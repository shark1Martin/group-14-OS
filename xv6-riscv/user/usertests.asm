...
copyinstr1(char *s)
{
  ...
  uint64 addrs[] = { 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
      ...
      14:	b8078793          	addi	a5,a5,-1152 # 7b90 <malloc+0x2680>
      18:	638c                	ld	a1,0(a5)
      1a:	6790                	ld	a2,8(a5)
      1c:	6b94                	ld	a3,16(a5)
      1e:	6f98                	ld	a4,24(a5)
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
      ...
      70:	5a450513          	addi	a0,a0,1444 # 5610 <malloc+0x100>
      74:	3e4050ef          	jal	5458 <printf>
      exit(1);
      78:	4505                	li	a0,1
      ...
      9a:	8082                	ret
{
      ...
      aa:	58a50513          	addi	a0,a0,1418 # 5630 <malloc+0x120>
      ae:	3aa050ef          	jal	5458 <printf>
      exit(1);
      b2:	4505                	li	a0,1
...
00000000000000b8 <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ca:	58250513          	addi	a0,a0,1410 # 5648 <malloc+0x138>
  ...
  fd = open("doesnotexist", 0);
      ...
      e0:	58c50513          	addi	a0,a0,1420 # 5668 <malloc+0x158>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      fc:	55850513          	addi	a0,a0,1368 # 5650 <malloc+0x140>
     100:	358050ef          	jal	5458 <printf>
    exit(1);
     104:	4505                	li	a0,1
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     110:	56c50513          	addi	a0,a0,1388 # 5678 <malloc+0x168>
     114:	344050ef          	jal	5458 <printf>
    exit(1);
     118:	4505                	li	a0,1
...
000000000000011e <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     186:	51e50513          	addi	a0,a0,1310 # 56a0 <malloc+0x190>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1b0:	51450513          	addi	a0,a0,1300 # 56c0 <malloc+0x1b0>
     1b4:	2a4050ef          	jal	5458 <printf>
    exit(1);
     1b8:	4505                	li	a0,1
...
0000000000000240 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     260:	48c50513          	addi	a0,a0,1164 # 56e8 <malloc+0x1d8>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     274:	478a0a13          	addi	s4,s4,1144 # 56e8 <malloc+0x1d8>
     278:	4b09                	li	s6,2
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     2e0:	41c50513          	addi	a0,a0,1052 # 56f8 <malloc+0x1e8>
     2e4:	174050ef          	jal	5458 <printf>
      exit(1);
     2e8:	4505                	li	a0,1
     ...
     2f8:	42450513          	addi	a0,a0,1060 # 5718 <malloc+0x208>
     2fc:	15c050ef          	jal	5458 <printf>
        exit(1);
     300:	4505                	li	a0,1
...
badwrite(char *s)
{
  ...
  unlink("junk");
     ...
     31e:	41650513          	addi	a0,a0,1046 # 5730 <malloc+0x220>
  ...
  for(int i = 0; i < assumed_free; i++){
    int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     332:	40298993          	addi	s3,s3,1026 # 5730 <malloc+0x220>
    if(fd < 0){
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     36e:	3c650513          	addi	a0,a0,966 # 5730 <malloc+0x220>
  ...
  if(write(fd, "x", 1) != 1){
     ...
     382:	33a58593          	addi	a1,a1,826 # 56b8 <malloc+0x1a8>
     386:	485040ef          	jal	500a <write>
     38a:	4785                	li	a5,1
     38c:	02f50d63          	beq	a0,a5,3c6 <badwrite+0xc0>
    printf("write failed\n");
     390:	00005517          	auipc	a0,0x5
     394:	3c050513          	addi	a0,a0,960 # 5750 <malloc+0x240>
     398:	0c0050ef          	jal	5458 <printf>
    exit(1);
     39c:	4505                	li	a0,1
     39e:	44d040ef          	jal	4fea <exit>
      printf("open junk failed\n");
     3a2:	00005517          	auipc	a0,0x5
     3a6:	39650513          	addi	a0,a0,918 # 5738 <malloc+0x228>
     3aa:	0ae050ef          	jal	5458 <printf>
      exit(1);
     3ae:	4505                	li	a0,1
     3b0:	43b040ef          	jal	4fea <exit>
    printf("open junk failed\n");
     3b4:	00005517          	auipc	a0,0x5
     3b8:	38450513          	addi	a0,a0,900 # 5738 <malloc+0x228>
     3bc:	09c050ef          	jal	5458 <printf>
    exit(1);
     3c0:	4505                	li	a0,1
  ...
  unlink("junk");
     ...
     3d0:	36450513          	addi	a0,a0,868 # 5730 <malloc+0x220>
...
00000000000004aa <copyin>:
{
  ...
  uint64 addrs[] = { 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
     ...
     4c8:	6cc78793          	addi	a5,a5,1740 # 7b90 <malloc+0x2680>
     4cc:	638c                	ld	a1,0(a5)
     4ce:	6790                	ld	a2,8(a5)
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     4fa:	26aa8a93          	addi	s5,s5,618 # 5760 <malloc+0x250>
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
     ...
     58c:	1e050513          	addi	a0,a0,480 # 5768 <malloc+0x258>
     590:	6c9040ef          	jal	5458 <printf>
      exit(1);
     594:	4505                	li	a0,1
     ...
     5a2:	1e250513          	addi	a0,a0,482 # 5780 <malloc+0x270>
     5a6:	6b3040ef          	jal	5458 <printf>
      exit(1);
     5aa:	4505                	li	a0,1
     ...
     5b8:	1fc50513          	addi	a0,a0,508 # 57b0 <malloc+0x2a0>
     5bc:	69d040ef          	jal	5458 <printf>
      exit(1);
     5c0:	4505                	li	a0,1
     5c2:	229040ef          	jal	4fea <exit>
      printf("pipe() failed\n");
     5c6:	00005517          	auipc	a0,0x5
     5ca:	21a50513          	addi	a0,a0,538 # 57e0 <malloc+0x2d0>
     5ce:	68b040ef          	jal	5458 <printf>
      exit(1);
     5d2:	4505                	li	a0,1
     ...
     5e0:	21450513          	addi	a0,a0,532 # 57f0 <malloc+0x2e0>
     5e4:	675040ef          	jal	5458 <printf>
      exit(1);
     5e8:	4505                	li	a0,1
...
00000000000005ee <copyout>:
{
  ...
  uint64 addrs[] = { 0LL, 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
     ...
     60c:	58878793          	addi	a5,a5,1416 # 7b90 <malloc+0x2680>
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
    ...
    int fd = open("README", 0);
     ...
     640:	1e4b0b13          	addi	s6,s6,484 # 5820 <malloc+0x310>
    ...
    n = write(fds[1], "x", 1);
     ...
     650:	06cb8b93          	addi	s7,s7,108 # 56b8 <malloc+0x1a8>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
     ...
     6d6:	15650513          	addi	a0,a0,342 # 5828 <malloc+0x318>
     6da:	57f040ef          	jal	5458 <printf>
      exit(1);
     6de:	4505                	li	a0,1
     ...
     6ec:	15850513          	addi	a0,a0,344 # 5840 <malloc+0x330>
     6f0:	569040ef          	jal	5458 <printf>
      exit(1);
     6f4:	4505                	li	a0,1
     6f6:	0f5040ef          	jal	4fea <exit>
      printf("pipe() failed\n");
     6fa:	00005517          	auipc	a0,0x5
     6fe:	0e650513          	addi	a0,a0,230 # 57e0 <malloc+0x2d0>
     702:	557040ef          	jal	5458 <printf>
      exit(1);
     706:	4505                	li	a0,1
     708:	0e3040ef          	jal	4fea <exit>
      printf("pipe write failed\n");
     70c:	00005517          	auipc	a0,0x5
     710:	16450513          	addi	a0,a0,356 # 5870 <malloc+0x360>
     714:	545040ef          	jal	5458 <printf>
      exit(1);
     718:	4505                	li	a0,1
     ...
     726:	16650513          	addi	a0,a0,358 # 5888 <malloc+0x378>
     72a:	52f040ef          	jal	5458 <printf>
      exit(1);
     72e:	4505                	li	a0,1
...
0000000000000734 <truncate1>:
{
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     780:	f2450513          	addi	a0,a0,-220 # 56a0 <malloc+0x190>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     7a4:	f0050513          	addi	a0,a0,-256 # 56a0 <malloc+0x190>
     7a8:	083040ef          	jal	502a <open>
     7ac:	89aa                	mv	s3,a0
  int fd3 = open("truncfile", O_RDONLY);
     7ae:	4581                	li	a1,0
     7b0:	00005517          	auipc	a0,0x5
     7b4:	ef050513          	addi	a0,a0,-272 # 56a0 <malloc+0x190>
  ...
  write(fd1, "abcdef", 6);
     ...
     7e6:	13658593          	addi	a1,a1,310 # 5918 <malloc+0x408>
     7ea:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     81c:	e8850513          	addi	a0,a0,-376 # 56a0 <malloc+0x190>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     850:	06c50513          	addi	a0,a0,108 # 58b8 <malloc+0x3a8>
     854:	405040ef          	jal	5458 <printf>
    exit(1);
     858:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     864:	07850513          	addi	a0,a0,120 # 58d8 <malloc+0x3c8>
     868:	3f1040ef          	jal	5458 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     86c:	8656                	mv	a2,s5
     86e:	85d2                	mv	a1,s4
     870:	00005517          	auipc	a0,0x5
     874:	07850513          	addi	a0,a0,120 # 58e8 <malloc+0x3d8>
     878:	3e1040ef          	jal	5458 <printf>
    exit(1);
     87c:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     888:	08450513          	addi	a0,a0,132 # 5908 <malloc+0x3f8>
     88c:	3cd040ef          	jal	5458 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     890:	8656                	mv	a2,s5
     892:	85d2                	mv	a1,s4
     894:	00005517          	auipc	a0,0x5
     898:	05450513          	addi	a0,a0,84 # 58e8 <malloc+0x3d8>
     89c:	3bd040ef          	jal	5458 <printf>
    exit(1);
     8a0:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     8ae:	07650513          	addi	a0,a0,118 # 5920 <malloc+0x410>
     8b2:	3a7040ef          	jal	5458 <printf>
    exit(1);
     8b6:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     8c4:	08050513          	addi	a0,a0,128 # 5940 <malloc+0x430>
     8c8:	391040ef          	jal	5458 <printf>
    exit(1);
     8cc:	4505                	li	a0,1
...
00000000000008d2 <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     8f2:	07250513          	addi	a0,a0,114 # 5960 <malloc+0x450>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     908:	084a0a13          	addi	s4,s4,132 # 5988 <malloc+0x478>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     90c:	00005b17          	auipc	s6,0x5
     910:	0b4b0b13          	addi	s6,s6,180 # 59c0 <malloc+0x4b0>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     946:	01e50513          	addi	a0,a0,30 # 5960 <malloc+0x450>
  ...
  if(unlink("small") < 0){
     ...
     976:	fee50513          	addi	a0,a0,-18 # 5960 <malloc+0x450>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     99e:	fce50513          	addi	a0,a0,-50 # 5968 <malloc+0x458>
     9a2:	2b7040ef          	jal	5458 <printf>
    exit(1);
     9a6:	4505                	li	a0,1
     ...
     9b4:	fe850513          	addi	a0,a0,-24 # 5998 <malloc+0x488>
     9b8:	2a1040ef          	jal	5458 <printf>
      exit(1);
     9bc:	4505                	li	a0,1
     ...
     9ca:	00a50513          	addi	a0,a0,10 # 59d0 <malloc+0x4c0>
     9ce:	28b040ef          	jal	5458 <printf>
      exit(1);
     9d2:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     9de:	01e50513          	addi	a0,a0,30 # 59f8 <malloc+0x4e8>
     9e2:	277040ef          	jal	5458 <printf>
    exit(1);
     9e6:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     9f2:	02a50513          	addi	a0,a0,42 # 5a18 <malloc+0x508>
     9f6:	263040ef          	jal	5458 <printf>
    exit(1);
     9fa:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     a06:	02e50513          	addi	a0,a0,46 # 5a30 <malloc+0x520>
     a0a:	24f040ef          	jal	5458 <printf>
    exit(1);
     a0e:	4505                	li	a0,1
...
0000000000000a14 <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     a32:	02250513          	addi	a0,a0,34 # 5a50 <malloc+0x540>
  ...
  fd = open("big", O_RDONLY);
     ...
     a76:	fde50513          	addi	a0,a0,-34 # 5a50 <malloc+0x540>
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     ab4:	fa850513          	addi	a0,a0,-88 # 5a58 <malloc+0x548>
     ab8:	1a1040ef          	jal	5458 <printf>
    exit(1);
     abc:	4505                	li	a0,1
     ...
     aca:	fb250513          	addi	a0,a0,-78 # 5a78 <malloc+0x568>
     ace:	18b040ef          	jal	5458 <printf>
      exit(1);
     ad2:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     ade:	fc650513          	addi	a0,a0,-58 # 5aa0 <malloc+0x590>
     ae2:	177040ef          	jal	5458 <printf>
    exit(1);
     ae6:	4505                	li	a0,1
  ...
  if(unlink("big") < 0){
     ...
     afe:	f5650513          	addi	a0,a0,-170 # 5a50 <malloc+0x540>
     ...
     b26:	f9e50513          	addi	a0,a0,-98 # 5ac0 <malloc+0x5b0>
     b2a:	12f040ef          	jal	5458 <printf>
        exit(1);
     b2e:	4505                	li	a0,1
     ...
     b3c:	fb050513          	addi	a0,a0,-80 # 5ae8 <malloc+0x5d8>
     b40:	119040ef          	jal	5458 <printf>
      exit(1);
     b44:	4505                	li	a0,1
     ...
     b52:	fb250513          	addi	a0,a0,-78 # 5b00 <malloc+0x5f0>
     b56:	103040ef          	jal	5458 <printf>
      exit(1);
     b5a:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b66:	fc650513          	addi	a0,a0,-58 # 5b28 <malloc+0x618>
     b6a:	0ef040ef          	jal	5458 <printf>
    exit(1);
     b6e:	4505                	li	a0,1
...
0000000000000b74 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b8c:	fb850513          	addi	a0,a0,-72 # 5b40 <malloc+0x630>
  ...
  write(fd, "hello", SZ);
     ...
     ba0:	fd458593          	addi	a1,a1,-44 # 5b70 <malloc+0x660>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     bb4:	f9050513          	addi	a0,a0,-112 # 5b40 <malloc+0x630>
  ...
  unlink("unlinkread");
     ...
     c3c:	f0850513          	addi	a0,a0,-248 # 5b40 <malloc+0x630>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c58:	efc50513          	addi	a0,a0,-260 # 5b50 <malloc+0x640>
     c5c:	7fc040ef          	jal	5458 <printf>
    exit(1);
     c60:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     c6c:	f1050513          	addi	a0,a0,-240 # 5b78 <malloc+0x668>
     c70:	7e8040ef          	jal	5458 <printf>
    exit(1);
     c74:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     c80:	f1c50513          	addi	a0,a0,-228 # 5b98 <malloc+0x688>
     c84:	7d4040ef          	jal	5458 <printf>
    exit(1);
     c88:	4505                	li	a0,1
    ...
    printf("%s: unlinkread read failed", s);
     ...
     c94:	f3050513          	addi	a0,a0,-208 # 5bc0 <malloc+0x6b0>
     c98:	7c0040ef          	jal	5458 <printf>
    exit(1);
     c9c:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ca8:	f3c50513          	addi	a0,a0,-196 # 5be0 <malloc+0x6d0>
     cac:	7ac040ef          	jal	5458 <printf>
    exit(1);
     cb0:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     cbc:	f4850513          	addi	a0,a0,-184 # 5c00 <malloc+0x6f0>
     cc0:	798040ef          	jal	5458 <printf>
    exit(1);
     cc4:	4505                	li	a0,1
...
0000000000000cca <linktest>:
{
  ...
  unlink("lf1");
     ...
     cdc:	f4850513          	addi	a0,a0,-184 # 5c20 <malloc+0x710>
     ce0:	35a040ef          	jal	503a <unlink>
  unlink("lf2");
     ce4:	00005517          	auipc	a0,0x5
     ce8:	f4450513          	addi	a0,a0,-188 # 5c28 <malloc+0x718>
     cec:	34e040ef          	jal	503a <unlink>
  fd = open("lf1", O_CREATE|O_RDWR);
     cf0:	20200593          	li	a1,514
     cf4:	00005517          	auipc	a0,0x5
     cf8:	f2c50513          	addi	a0,a0,-212 # 5c20 <malloc+0x710>
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     d0c:	e6858593          	addi	a1,a1,-408 # 5b70 <malloc+0x660>
  ...
  if(link(".", "lf1") >= 0){
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     de4:	e5050513          	addi	a0,a0,-432 # 5c30 <malloc+0x720>
     de8:	670040ef          	jal	5458 <printf>
    exit(1);
     dec:	4505                	li	a0,1
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     df8:	e5450513          	addi	a0,a0,-428 # 5c48 <malloc+0x738>
     dfc:	65c040ef          	jal	5458 <printf>
    exit(1);
     e00:	4505                	li	a0,1
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     e0c:	e5850513          	addi	a0,a0,-424 # 5c60 <malloc+0x750>
     e10:	648040ef          	jal	5458 <printf>
    exit(1);
     e14:	4505                	li	a0,1
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     e20:	e6450513          	addi	a0,a0,-412 # 5c80 <malloc+0x770>
     e24:	634040ef          	jal	5458 <printf>
    exit(1);
     e28:	4505                	li	a0,1
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     e34:	e8050513          	addi	a0,a0,-384 # 5cb0 <malloc+0x7a0>
     e38:	620040ef          	jal	5458 <printf>
    exit(1);
     e3c:	4505                	li	a0,1
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     e48:	e8450513          	addi	a0,a0,-380 # 5cc8 <malloc+0x7b8>
     e4c:	60c040ef          	jal	5458 <printf>
    exit(1);
     e50:	4505                	li	a0,1
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     e5c:	e8850513          	addi	a0,a0,-376 # 5ce0 <malloc+0x7d0>
     e60:	5f8040ef          	jal	5458 <printf>
    exit(1);
     e64:	4505                	li	a0,1
    ...
    printf("%s: link non-existent succeeded! oops\n", s);
     ...
     e70:	e9c50513          	addi	a0,a0,-356 # 5d08 <malloc+0x7f8>
     e74:	5e4040ef          	jal	5458 <printf>
    exit(1);
     e78:	4505                	li	a0,1
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     e84:	eb850513          	addi	a0,a0,-328 # 5d38 <malloc+0x828>
     e88:	5d0040ef          	jal	5458 <printf>
    exit(1);
     e8c:	4505                	li	a0,1
...
0000000000000e92 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    if(link("nosuchfile", (char*)p) != -1){
     ...
     eae:	eae98993          	addi	s3,s3,-338 # 5d58 <malloc+0x848>
     eb2:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
     eb4:	6a85                	lui	s5,0x1
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
     ...
     ee6:	e8650513          	addi	a0,a0,-378 # 5d68 <malloc+0x858>
     eea:	56e040ef          	jal	5458 <printf>
      exit(1);
     eee:	4505                	li	a0,1
...
0000000000000ef4 <bigdir>:
{
  ...
  unlink("bd");
     ...
     f10:	e7c50513          	addi	a0,a0,-388 # 5d88 <malloc+0x878>
     f14:	126040ef          	jal	503a <unlink>
  fd = open("bd", O_CREATE);
     f18:	20000593          	li	a1,512
     f1c:	00005517          	auipc	a0,0x5
     f20:	e6c50513          	addi	a0,a0,-404 # 5d88 <malloc+0x878>
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     f3e:	e4e98993          	addi	s3,s3,-434 # 5d88 <malloc+0x878>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
     ...
     f8a:	e0250513          	addi	a0,a0,-510 # 5d88 <malloc+0x878>
  ...
  for(i = 0; i < N; i++){
    ...
    printf("%s: bigdir create failed\n", s);
     ...
     ff6:	d9e50513          	addi	a0,a0,-610 # 5d90 <malloc+0x880>
     ffa:	45e040ef          	jal	5458 <printf>
    exit(1);
     ffe:	4505                	li	a0,1
    ...
    1010:	da450513          	addi	a0,a0,-604 # 5db0 <malloc+0x8a0>
    1014:	444040ef          	jal	5458 <printf>
      exit(1);
    1018:	4505                	li	a0,1
    ...
    1024:	db850513          	addi	a0,a0,-584 # 5dd8 <malloc+0x8c8>
    1028:	430040ef          	jal	5458 <printf>
      exit(1);
    102c:	4505                	li	a0,1
...
000000000000105e <badarg>:
{
    ...
    1082:	5ca98993          	addi	s3,s3,1482 # 5648 <malloc+0x138>
    argv[0] = (char*)0xffffffff;
...
00000000000010a0 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    10f6:	e3678793          	addi	a5,a5,-458 # 6f28 <malloc+0x1a18>
  ...
  if(pid == 0){
    ...
    114a:	a4a78793          	addi	a5,a5,-1462 # 7b90 <malloc+0x2680>
    ...
    116e:	4de50513          	addi	a0,a0,1246 # 5648 <malloc+0x138>
    ...
    1182:	d0250513          	addi	a0,a0,-766 # 5e80 <malloc+0x970>
    1186:	2d2040ef          	jal	5458 <printf>
      exit(1);
    118a:	4505                	li	a0,1
    ...
    119a:	c6250513          	addi	a0,a0,-926 # 5df8 <malloc+0x8e8>
    119e:	2ba040ef          	jal	5458 <printf>
    exit(1);
    11a2:	4505                	li	a0,1
    ...
    11b2:	c6a50513          	addi	a0,a0,-918 # 5e18 <malloc+0x908>
    11b6:	2a2040ef          	jal	5458 <printf>
    exit(1);
    11ba:	4505                	li	a0,1
    ...
    11cc:	c7050513          	addi	a0,a0,-912 # 5e38 <malloc+0x928>
    11d0:	288040ef          	jal	5458 <printf>
    exit(1);
    11d4:	4505                	li	a0,1
    ...
    11e4:	c8050513          	addi	a0,a0,-896 # 5e60 <malloc+0x950>
    11e8:	270040ef          	jal	5458 <printf>
    exit(1);
    11ec:	4505                	li	a0,1
    11ee:	5fd030ef          	jal	4fea <exit>
    printf("fork failed\n");
    11f2:	00006517          	auipc	a0,0x6
    11f6:	28e50513          	addi	a0,a0,654 # 7480 <malloc+0x1f70>
    11fa:	25e040ef          	jal	5458 <printf>
    exit(1);
    11fe:	4505                	li	a0,1
  ...
  if(st != 747){
    ...
    1230:	c7c50513          	addi	a0,a0,-900 # 5ea8 <malloc+0x998>
    1234:	224040ef          	jal	5458 <printf>
    exit(1);
    1238:	4505                	li	a0,1
...
000000000000123e <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    1252:	45250513          	addi	a0,a0,1106 # 56a0 <malloc+0x190>
  ...
  if(pid == 0){
    ...
    1282:	42298993          	addi	s3,s3,1058 # 56a0 <malloc+0x190>
      int n = write(fd, "1234567890", 10);
    1286:	4a29                	li	s4,10
    1288:	00005b17          	auipc	s6,0x5
    128c:	c80b0b13          	addi	s6,s6,-896 # 5f08 <malloc+0x9f8>
    ...
    12f2:	bea50513          	addi	a0,a0,-1046 # 5ed8 <malloc+0x9c8>
    12f6:	162040ef          	jal	5458 <printf>
    exit(1);
    12fa:	4505                	li	a0,1
    ...
    1306:	bee50513          	addi	a0,a0,-1042 # 5ef0 <malloc+0x9e0>
    130a:	14e040ef          	jal	5458 <printf>
        exit(1);
    130e:	4505                	li	a0,1
    ...
    131c:	c0050513          	addi	a0,a0,-1024 # 5f18 <malloc+0xa08>
    1320:	138040ef          	jal	5458 <printf>
        exit(1);
    1324:	4505                	li	a0,1
    ...
    1342:	362a0a13          	addi	s4,s4,866 # 56a0 <malloc+0x190>
    int n = write(fd, "xxx", 3);
    1346:	498d                	li	s3,3
    1348:	00005b17          	auipc	s6,0x5
    134c:	bf0b0b13          	addi	s6,s6,-1040 # 5f38 <malloc+0xa28>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
    1350:	85d6                	mv	a1,s5
    1352:	8552                	mv	a0,s4
  ...
  unlink("truncfile");
    ...
    1386:	31e50513          	addi	a0,a0,798 # 56a0 <malloc+0x190>
  ...
  exit(xstatus);
    ...
    13a0:	b5450513          	addi	a0,a0,-1196 # 5ef0 <malloc+0x9e0>
    13a4:	0b4040ef          	jal	5458 <printf>
      exit(1);
    13a8:	4505                	li	a0,1
    ...
    13ba:	b8a50513          	addi	a0,a0,-1142 # 5f40 <malloc+0xa30>
    13be:	09a040ef          	jal	5458 <printf>
      exit(1);
    13c2:	4505                	li	a0,1
...
00000000000013c8 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    13d8:	27478793          	addi	a5,a5,628 # 5648 <malloc+0x138>
    13dc:	fcf43023          	sd	a5,-64(s0)
    13e0:	00005797          	auipc	a5,0x5
    13e4:	b8078793          	addi	a5,a5,-1152 # 5f60 <malloc+0xa50>
    13e8:	fcf43423          	sd	a5,-56(s0)
    13ec:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    13f0:	00005517          	auipc	a0,0x5
    13f4:	b7850513          	addi	a0,a0,-1160 # 5f68 <malloc+0xa58>
  ...
  if(pid == 0) {
    ...
    1418:	b5450513          	addi	a0,a0,-1196 # 5f68 <malloc+0xa58>
    ...
    1430:	b5c50513          	addi	a0,a0,-1188 # 5f88 <malloc+0xa78>
    1434:	024040ef          	jal	5458 <printf>
      exit(1);
    1438:	4505                	li	a0,1
    ...
    1446:	a9650513          	addi	a0,a0,-1386 # 5ed8 <malloc+0x9c8>
    144a:	00e040ef          	jal	5458 <printf>
     exit(1);
    144e:	4505                	li	a0,1
    ...
    145a:	b1a50513          	addi	a0,a0,-1254 # 5f70 <malloc+0xa60>
    145e:	7fb030ef          	jal	5458 <printf>
      exit(1);
    1462:	4505                	li	a0,1
    ...
    1470:	1dc50513          	addi	a0,a0,476 # 5648 <malloc+0x138>
  ...
  if(xstatus != 0)
    ...
    1498:	b0450513          	addi	a0,a0,-1276 # 5f98 <malloc+0xa88>
    149c:	7bd030ef          	jal	5458 <printf>
      exit(1);
    14a0:	4505                	li	a0,1
    ...
    14ac:	b0850513          	addi	a0,a0,-1272 # 5fb0 <malloc+0xaa0>
    14b0:	7a9030ef          	jal	5458 <printf>
    14b4:	bfd1                	j	1488 <exectest+0xc0>
  fd = open("echo-ok", O_RDONLY);
    14b6:	4581                	li	a1,0
    14b8:	00005517          	auipc	a0,0x5
    14bc:	ab050513          	addi	a0,a0,-1360 # 5f68 <malloc+0xa58>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    14de:	53e50513          	addi	a0,a0,1342 # 5a18 <malloc+0x508>
    14e2:	777030ef          	jal	5458 <printf>
    exit(1);
    14e6:	4505                	li	a0,1
    ...
    14f2:	a0250513          	addi	a0,a0,-1534 # 5ef0 <malloc+0x9e0>
    14f6:	763030ef          	jal	5458 <printf>
    exit(1);
    14fa:	4505                	li	a0,1
    14fc:	2ef030ef          	jal	4fea <exit>
  unlink("echo-ok");
    1500:	00005517          	auipc	a0,0x5
    1504:	a6850513          	addi	a0,a0,-1432 # 5f68 <malloc+0xa58>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    152a:	aa250513          	addi	a0,a0,-1374 # 5fc8 <malloc+0xab8>
    152e:	72b030ef          	jal	5458 <printf>
    exit(1);
    1532:	4505                	li	a0,1
...
000000000000153e <pipe1>:
{
  ...
  if(pid == 0){
    ...
    15d6:	a0e50513          	addi	a0,a0,-1522 # 5fe0 <malloc+0xad0>
    15da:	67f030ef          	jal	5458 <printf>
    exit(1);
    15de:	4505                	li	a0,1
    ...
    1612:	42da8a93          	addi	s5,s5,1069 # 142d <exectest+0x65>
{
    ...
    1650:	9ac50513          	addi	a0,a0,-1620 # 5ff8 <malloc+0xae8>
    1654:	605030ef          	jal	5458 <printf>
        exit(1);
    1658:	4505                	li	a0,1
    ...
    1664:	9b050513          	addi	a0,a0,-1616 # 6010 <malloc+0xb00>
    1668:	5f1030ef          	jal	5458 <printf>
          return;
    ...
    1696:	99650513          	addi	a0,a0,-1642 # 6028 <malloc+0xb18>
    169a:	5bf030ef          	jal	5458 <printf>
      exit(1);
    169e:	4505                	li	a0,1
    ...
    16d2:	97a50513          	addi	a0,a0,-1670 # 6048 <malloc+0xb38>
    16d6:	583030ef          	jal	5458 <printf>
    exit(1);
    16da:	4505                	li	a0,1
...
00000000000016e0 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    173a:	7a250513          	addi	a0,a0,1954 # 5ed8 <malloc+0x9c8>
    173e:	51b030ef          	jal	5458 <printf>
      exit(1);
    1742:	4505                	li	a0,1
    ...
    174e:	91650513          	addi	a0,a0,-1770 # 6060 <malloc+0xb50>
    1752:	507030ef          	jal	5458 <printf>
        exit(1);
    1756:	4505                	li	a0,1
    ...
    1762:	91a50513          	addi	a0,a0,-1766 # 6078 <malloc+0xb68>
    1766:	4f3030ef          	jal	5458 <printf>
        exit(1);
    176a:	4505                	li	a0,1
...
0000000000001776 <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    17be:	71e50513          	addi	a0,a0,1822 # 5ed8 <malloc+0x9c8>
    17c2:	497030ef          	jal	5458 <printf>
      exit(1);
    17c6:	4505                	li	a0,1
    ...
    17d6:	70650513          	addi	a0,a0,1798 # 5ed8 <malloc+0x9c8>
    17da:	47f030ef          	jal	5458 <printf>
        exit(1);
    17de:	4505                	li	a0,1
...
00000000000017e8 <forkfork>:
{
    ...
    1834:	86850513          	addi	a0,a0,-1944 # 6098 <malloc+0xb88>
    1838:	421030ef          	jal	5458 <printf>
      exit(1);
    183c:	4505                	li	a0,1
    183e:	7ac030ef          	jal	4fea <exit>
{
    ...
    1870:	83c50513          	addi	a0,a0,-1988 # 60a8 <malloc+0xb98>
    1874:	3e5030ef          	jal	5458 <printf>
      exit(1);
    1878:	4505                	li	a0,1
...
000000000000187e <reparent2>:
{
  ...
  exit(0);
    ...
    18aa:	bda50513          	addi	a0,a0,-1062 # 7480 <malloc+0x1f70>
    18ae:	3ab030ef          	jal	5458 <printf>
      exit(1);
    18b2:	4505                	li	a0,1
...
00000000000018c6 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1936:	5a650513          	addi	a0,a0,1446 # 5ed8 <malloc+0x9c8>
    193a:	31f030ef          	jal	5458 <printf>
      exit(1);
    193e:	4505                	li	a0,1
    ...
    1962:	61250513          	addi	a0,a0,1554 # 5f70 <malloc+0xa60>
    1966:	2f3030ef          	jal	5458 <printf>
          exit(1);
    196a:	4505                	li	a0,1
    ...
    19c2:	70a50513          	addi	a0,a0,1802 # 60c8 <malloc+0xbb8>
    19c6:	293030ef          	jal	5458 <printf>
            exit(1);
    19ca:	4505                	li	a0,1
    ...
    1a0c:	6d850513          	addi	a0,a0,1752 # 60e0 <malloc+0xbd0>
    1a10:	249030ef          	jal	5458 <printf>
        exit(1);
    1a14:	4505                	li	a0,1
    ...
    1a28:	6e450513          	addi	a0,a0,1764 # 6108 <malloc+0xbf8>
    1a2c:	22d030ef          	jal	5458 <printf>
        exit(1);
    1a30:	4505                	li	a0,1
...
0000000000001ab2 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1ad4:	be850513          	addi	a0,a0,-1048 # 56b8 <malloc+0x1a8>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1b14:	ba8b0b13          	addi	s6,s6,-1112 # 56b8 <malloc+0x1a8>
      link("cat", "x");
    1b18:	00004c97          	auipc	s9,0x4
    1b1c:	618c8c93          	addi	s9,s9,1560 # 6130 <malloc+0xc20>
    ...
    1b2c:	3b050513          	addi	a0,a0,944 # 5ed8 <malloc+0x9c8>
    1b30:	129030ef          	jal	5458 <printf>
    exit(1);
    1b34:	4505                	li	a0,1
...
0000000000001bac <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    1bd8:	5ac50513          	addi	a0,a0,1452 # 6180 <malloc+0xc70>
    1bdc:	07d030ef          	jal	5458 <printf>
    exit(1);
    1be0:	4505                	li	a0,1
    ...
    1bf0:	54c50513          	addi	a0,a0,1356 # 6138 <malloc+0xc28>
    1bf4:	065030ef          	jal	5458 <printf>
    exit(1);
    1bf8:	4505                	li	a0,1
    ...
    1c04:	55050513          	addi	a0,a0,1360 # 6150 <malloc+0xc40>
    1c08:	051030ef          	jal	5458 <printf>
      exit(1);
    1c0c:	4505                	li	a0,1
    ...
    1c18:	55450513          	addi	a0,a0,1364 # 6168 <malloc+0xc58>
    1c1c:	03d030ef          	jal	5458 <printf>
    exit(1);
    1c20:	4505                	li	a0,1
...
0000000000001c54 <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    1cbc:	22050513          	addi	a0,a0,544 # 5ed8 <malloc+0x9c8>
    1cc0:	798030ef          	jal	5458 <printf>
      exit(1);
    1cc4:	4505                	li	a0,1
    ...
    1cd6:	4d650513          	addi	a0,a0,1238 # 61a8 <malloc+0xc98>
    1cda:	77e030ef          	jal	5458 <printf>
      exit(1);
    1cde:	4505                	li	a0,1
...
0000000000001cea <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    1d4a:	19250513          	addi	a0,a0,402 # 5ed8 <malloc+0x9c8>
    1d4e:	70a030ef          	jal	5458 <printf>
      exit(1);
    1d52:	4505                	li	a0,1
    ...
    1d6e:	45e50513          	addi	a0,a0,1118 # 61c8 <malloc+0xcb8>
    1d72:	6e6030ef          	jal	5458 <printf>
      exit(1);
    1d76:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    1dbe:	42650513          	addi	a0,a0,1062 # 61e0 <malloc+0xcd0>
    1dc2:	696030ef          	jal	5458 <printf>
    exit(1);
    1dc6:	4505                	li	a0,1
    ...
    1dd2:	10a50513          	addi	a0,a0,266 # 5ed8 <malloc+0x9c8>
    1dd6:	682030ef          	jal	5458 <printf>
    exit(1);
    1dda:	4505                	li	a0,1
...
0000000000001de6 <nowrite>:
{
  ...
  uint64 addrs[] = { 0, 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
    ...
    1dfc:	d9878793          	addi	a5,a5,-616 # 7b90 <malloc+0x2680>
  ...
  exit(0);
    ...
    1e66:	3a650513          	addi	a0,a0,934 # 6208 <malloc+0xcf8>
    1e6a:	5ee030ef          	jal	5458 <printf>
      exit(0);
    1e6e:	4501                	li	a0,0
    ...
    1e7a:	06250513          	addi	a0,a0,98 # 5ed8 <malloc+0x9c8>
    1e7e:	5da030ef          	jal	5458 <printf>
      exit(1);
    1e82:	4505                	li	a0,1
...
0000000000001e8e <manywrites>:
{
  ...
  exit(0);
    ...
    1ef2:	59250513          	addi	a0,a0,1426 # 7480 <malloc+0x1f70>
    1ef6:	562030ef          	jal	5458 <printf>
      exit(1);
    1efa:	4505                	li	a0,1
    ...
    1f92:	29a50513          	addi	a0,a0,666 # 6228 <malloc+0xd18>
    1f96:	4c2030ef          	jal	5458 <printf>
            exit(1);
    1f9a:	4505                	li	a0,1
    ...
    1faa:	77250513          	addi	a0,a0,1906 # 5718 <malloc+0x208>
    1fae:	4aa030ef          	jal	5458 <printf>
            exit(1);
    1fb2:	4505                	li	a0,1
...
0000000000001fc8 <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    202a:	f0278793          	addi	a5,a5,-254 # 6f28 <malloc+0x1a18>
  ...
  if(ret != -1){
    ...
    2064:	1e050513          	addi	a0,a0,480 # 6240 <malloc+0xd30>
    2068:	3f0030ef          	jal	5458 <printf>
    exit(1);
    206c:	4505                	li	a0,1
    ...
    207a:	d8250513          	addi	a0,a0,-638 # 5df8 <malloc+0x8e8>
    207e:	3da030ef          	jal	5458 <printf>
    exit(1);
    2082:	4505                	li	a0,1
    ...
    2090:	d8c50513          	addi	a0,a0,-628 # 5e18 <malloc+0x908>
    2094:	3c4030ef          	jal	5458 <printf>
    exit(1);
    2098:	4505                	li	a0,1
    ...
    20a8:	d9450513          	addi	a0,a0,-620 # 5e38 <malloc+0x928>
    20ac:	3ac030ef          	jal	5458 <printf>
    exit(1);
    20b0:	4505                	li	a0,1
    ...
    20be:	da650513          	addi	a0,a0,-602 # 5e60 <malloc+0x950>
    20c2:	396030ef          	jal	5458 <printf>
    exit(1);
    20c6:	4505                	li	a0,1
...
00000000000020cc <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    20fa:	18a50513          	addi	a0,a0,394 # 6280 <malloc+0xd70>
  ...
  if(n >= 0){
    ...
    2122:	18250513          	addi	a0,a0,386 # 62a0 <malloc+0xd90>
    2126:	332030ef          	jal	5458 <printf>
    exit(1);
    212a:	4505                	li	a0,1
    ...
    2138:	11450513          	addi	a0,a0,276 # 6248 <malloc+0xd38>
    213c:	31c030ef          	jal	5458 <printf>
    exit(1);
    2140:	4505                	li	a0,1
    ...
    214c:	11850513          	addi	a0,a0,280 # 6260 <malloc+0xd50>
    2150:	308030ef          	jal	5458 <printf>
    exit(1);
    2154:	4505                	li	a0,1
    2156:	695020ef          	jal	4fea <exit>
    printf("open(rwsbrk) failed\n");
    215a:	00004517          	auipc	a0,0x4
    215e:	12e50513          	addi	a0,a0,302 # 6288 <malloc+0xd78>
    2162:	2f6030ef          	jal	5458 <printf>
    exit(1);
    2166:	4505                	li	a0,1
  ...
  unlink("rwsbrk");
    ...
    2176:	10e50513          	addi	a0,a0,270 # 6280 <malloc+0xd70>
    217a:	6c1020ef          	jal	503a <unlink>
  fd = open("README", O_RDONLY);
    217e:	4581                	li	a1,0
    2180:	00003517          	auipc	a0,0x3
    2184:	6a050513          	addi	a0,a0,1696 # 5820 <malloc+0x310>
  ...
  if(n >= 0){
    ...
    21a6:	12e50513          	addi	a0,a0,302 # 62d0 <malloc+0xdc0>
    21aa:	2ae030ef          	jal	5458 <printf>
    exit(1);
    21ae:	4505                	li	a0,1
    21b0:	63b020ef          	jal	4fea <exit>
    printf("open(README) failed\n");
    21b4:	00003517          	auipc	a0,0x3
    21b8:	67450513          	addi	a0,a0,1652 # 5828 <malloc+0x318>
    21bc:	29c030ef          	jal	5458 <printf>
    exit(1);
    21c0:	4505                	li	a0,1
...
00000000000021d2 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    2226:	0d650513          	addi	a0,a0,214 # 62f8 <malloc+0xde8>
    222a:	22e030ef          	jal	5458 <printf>
    exit(1);
    222e:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    227e:	09e50513          	addi	a0,a0,158 # 6318 <malloc+0xe08>
    2282:	1d6030ef          	jal	5458 <printf>
    exit(1);
    2286:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    22c8:	0b450513          	addi	a0,a0,180 # 6378 <malloc+0xe68>
    22cc:	18c030ef          	jal	5458 <printf>
    exit(1);
    22d0:	4505                	li	a0,1
    ...
    22e2:	05a50513          	addi	a0,a0,90 # 6338 <malloc+0xe28>
    22e6:	172030ef          	jal	5458 <printf>
      exit(1);
    22ea:	4505                	li	a0,1
    ...
    22f6:	06650513          	addi	a0,a0,102 # 6358 <malloc+0xe48>
    22fa:	15e030ef          	jal	5458 <printf>
    exit(1);
    22fe:	4505                	li	a0,1
...
000000000000231e <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  if(c != a){
    ...
    23e2:	fba50513          	addi	a0,a0,-70 # 6398 <malloc+0xe88>
    23e6:	072030ef          	jal	5458 <printf>
    exit(1);
    23ea:	4505                	li	a0,1
    ...
    23f6:	fee50513          	addi	a0,a0,-18 # 63e0 <malloc+0xed0>
    23fa:	05e030ef          	jal	5458 <printf>
    exit(1);
    23fe:	4505                	li	a0,1
    ...
    240e:	ff650513          	addi	a0,a0,-10 # 6400 <malloc+0xef0>
    2412:	046030ef          	jal	5458 <printf>
    exit(1);
    2416:	4505                	li	a0,1
    ...
    2426:	01e50513          	addi	a0,a0,30 # 6440 <malloc+0xf30>
    242a:	02e030ef          	jal	5458 <printf>
    exit(1);
    242e:	4505                	li	a0,1
    ...
    243a:	03a50513          	addi	a0,a0,58 # 6470 <malloc+0xf60>
    243e:	01a030ef          	jal	5458 <printf>
    exit(1);
    2442:	4505                	li	a0,1
    ...
    2452:	05a50513          	addi	a0,a0,90 # 64a8 <malloc+0xf98>
    2456:	002030ef          	jal	5458 <printf>
    exit(1);
    245a:	4505                	li	a0,1
...
0000000000002460 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    2480:	05450513          	addi	a0,a0,84 # 64d0 <malloc+0xfc0>
    2484:	3a7020ef          	jal	502a <open>
    2488:	84aa                	mv	s1,a0
  unlink("sbrk");
    248a:	00004517          	auipc	a0,0x4
    248e:	04650513          	addi	a0,a0,70 # 64d0 <malloc+0xfc0>
  ...
  if(pipe((int *) a) != 0){
    ...
    24ce:	00e50513          	addi	a0,a0,14 # 64d8 <malloc+0xfc8>
    24d2:	787020ef          	jal	5458 <printf>
    exit(1);
    24d6:	4505                	li	a0,1
    ...
    24e2:	01250513          	addi	a0,a0,18 # 64f0 <malloc+0xfe0>
    24e6:	773020ef          	jal	5458 <printf>
    exit(1);
    24ea:	4505                	li	a0,1
    ...
    24f6:	aee50513          	addi	a0,a0,-1298 # 5fe0 <malloc+0xad0>
    24fa:	75f020ef          	jal	5458 <printf>
    exit(1);
    24fe:	4505                	li	a0,1
...
0000000000002504 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2518:	ff450513          	addi	a0,a0,-12 # 6508 <malloc+0xff8>
  ...
  close(fd);
    ...
    2550:	9a450513          	addi	a0,a0,-1628 # 5ef0 <malloc+0x9e0>
    2554:	705020ef          	jal	5458 <printf>
    exit(1);
    2558:	4505                	li	a0,1
...
000000000000255e <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2586:	efe50513          	addi	a0,a0,-258 # 7480 <malloc+0x1f70>
    258a:	6cf020ef          	jal	5458 <printf>
    exit(1);
    258e:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    25c0:	ec450513          	addi	a0,a0,-316 # 7480 <malloc+0x1f70>
    25c4:	695020ef          	jal	5458 <printf>
    exit(1);
    25c8:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2600:	e8450513          	addi	a0,a0,-380 # 7480 <malloc+0x1f70>
    2604:	655020ef          	jal	5458 <printf>
    exit(1);
    2608:	4505                	li	a0,1
...
00000000000026ea <execout>:
{
  ...
  exit(0);
    ...
    2726:	d5e50513          	addi	a0,a0,-674 # 7480 <malloc+0x1f70>
    272a:	52f020ef          	jal	5458 <printf>
      exit(1);
    272e:	4505                	li	a0,1
...
000000000000279a <fourteen>:
{
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    27ca:	dca50513          	addi	a0,a0,-566 # 6590 <malloc+0x1080>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    27e0:	e2c50513          	addi	a0,a0,-468 # 6608 <malloc+0x10f8>
  ...
  unlink("12345678901234");
    ...
    2864:	cb050513          	addi	a0,a0,-848 # 6510 <malloc+0x1000>
    2868:	3f1020ef          	jal	5458 <printf>
    exit(1);
    286c:	4505                	li	a0,1
    ...
    2878:	ce450513          	addi	a0,a0,-796 # 6558 <malloc+0x1048>
    287c:	3dd020ef          	jal	5458 <printf>
    exit(1);
    2880:	4505                	li	a0,1
    ...
    288c:	d3850513          	addi	a0,a0,-712 # 65c0 <malloc+0x10b0>
    2890:	3c9020ef          	jal	5458 <printf>
    exit(1);
    2894:	4505                	li	a0,1
    ...
    28a0:	d9c50513          	addi	a0,a0,-612 # 6638 <malloc+0x1128>
    28a4:	3b5020ef          	jal	5458 <printf>
    exit(1);
    28a8:	4505                	li	a0,1
    ...
    28b4:	de850513          	addi	a0,a0,-536 # 6698 <malloc+0x1188>
    28b8:	3a1020ef          	jal	5458 <printf>
    exit(1);
    28bc:	4505                	li	a0,1
    ...
    28c8:	e2c50513          	addi	a0,a0,-468 # 66f0 <malloc+0x11e0>
    28cc:	38d020ef          	jal	5458 <printf>
    exit(1);
    28d0:	4505                	li	a0,1
...
00000000000028d6 <diskfull>:
{
  ...
  unlink("diskfulldir");
    ...
    291a:	e1250513          	addi	a0,a0,-494 # 6728 <malloc+0x1218>
    ...
    2950:	dec50513          	addi	a0,a0,-532 # 6738 <malloc+0x1228>
    2954:	305020ef          	jal	5458 <printf>
      break;
  ...
  for(fi = 0; done == 0 && '0' + fi < 0177; fi++){
    ...
    2afe:	c5e50513          	addi	a0,a0,-930 # 6758 <malloc+0x1248>
    2b02:	157020ef          	jal	5458 <printf>
...
0000000000002b08 <iputtest>:
{
  ...
  if(chdir("/") < 0){
    ...
    2b64:	c3050513          	addi	a0,a0,-976 # 6790 <malloc+0x1280>
    2b68:	0f1020ef          	jal	5458 <printf>
    exit(1);
    2b6c:	4505                	li	a0,1
    ...
    2b78:	c3450513          	addi	a0,a0,-972 # 67a8 <malloc+0x1298>
    2b7c:	0dd020ef          	jal	5458 <printf>
    exit(1);
    2b80:	4505                	li	a0,1
    ...
    2b8c:	c5050513          	addi	a0,a0,-944 # 67d8 <malloc+0x12c8>
    2b90:	0c9020ef          	jal	5458 <printf>
    exit(1);
    2b94:	4505                	li	a0,1
    ...
    2ba0:	c6450513          	addi	a0,a0,-924 # 6800 <malloc+0x12f0>
    2ba4:	0b5020ef          	jal	5458 <printf>
    exit(1);
    2ba8:	4505                	li	a0,1
...
0000000000002bae <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    2c00:	2dc50513          	addi	a0,a0,732 # 5ed8 <malloc+0x9c8>
    2c04:	055020ef          	jal	5458 <printf>
    exit(1);
    2c08:	4505                	li	a0,1
    ...
    2c14:	b8050513          	addi	a0,a0,-1152 # 6790 <malloc+0x1280>
    2c18:	041020ef          	jal	5458 <printf>
      exit(1);
    2c1c:	4505                	li	a0,1
    ...
    2c28:	bf450513          	addi	a0,a0,-1036 # 6818 <malloc+0x1308>
    2c2c:	02d020ef          	jal	5458 <printf>
      exit(1);
    2c30:	4505                	li	a0,1
    ...
    2c3c:	ba050513          	addi	a0,a0,-1120 # 67d8 <malloc+0x12c8>
    2c40:	019020ef          	jal	5458 <printf>
      exit(1);
    2c44:	4505                	li	a0,1
...
0000000000002c5a <dirtest>:
{
  ...
  if(unlink("dir0") < 0){
    ...
    2cb6:	ade50513          	addi	a0,a0,-1314 # 6790 <malloc+0x1280>
    2cba:	79e020ef          	jal	5458 <printf>
    exit(1);
    2cbe:	4505                	li	a0,1
    ...
    2cca:	b7250513          	addi	a0,a0,-1166 # 6838 <malloc+0x1328>
    2cce:	78a020ef          	jal	5458 <printf>
    exit(1);
    2cd2:	4505                	li	a0,1
    ...
    2cde:	b7e50513          	addi	a0,a0,-1154 # 6858 <malloc+0x1348>
    2ce2:	776020ef          	jal	5458 <printf>
    exit(1);
    2ce6:	4505                	li	a0,1
    ...
    2cf2:	b8250513          	addi	a0,a0,-1150 # 6870 <malloc+0x1360>
    2cf6:	762020ef          	jal	5458 <printf>
    exit(1);
    2cfa:	4505                	li	a0,1
...
0000000000002d00 <subdir>:
{
  ...
  unlink("ff");
    ...
    2d12:	caa50513          	addi	a0,a0,-854 # 69b8 <malloc+0x14a8>
    2d16:	324020ef          	jal	503a <unlink>
  if(mkdir("dd") != 0){
    2d1a:	00004517          	auipc	a0,0x4
    2d1e:	b6e50513          	addi	a0,a0,-1170 # 6888 <malloc+0x1378>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    2d32:	b7a50513          	addi	a0,a0,-1158 # 68a8 <malloc+0x1398>
  ...
  write(fd, "ff", 2);
    ...
    2d46:	c7658593          	addi	a1,a1,-906 # 69b8 <malloc+0x14a8>
  ...
  if(unlink("dd") >= 0){
    ...
    2d58:	b3450513          	addi	a0,a0,-1228 # 6888 <malloc+0x1378>
    2d5c:	2de020ef          	jal	503a <unlink>
    2d60:	2c055963          	bgez	a0,3032 <subdir+0x332>
  if(mkdir("/dd/dd") != 0){
    2d64:	00004517          	auipc	a0,0x4
    2d68:	b9c50513          	addi	a0,a0,-1124 # 6900 <malloc+0x13f0>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    2d7c:	bb050513          	addi	a0,a0,-1104 # 6928 <malloc+0x1418>
  ...
  write(fd, "FF", 2);
    ...
    2d90:	bcc58593          	addi	a1,a1,-1076 # 6958 <malloc+0x1448>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    2da4:	bc050513          	addi	a0,a0,-1088 # 6960 <malloc+0x1450>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    2e8a:	aa250513          	addi	a0,a0,-1374 # 6928 <malloc+0x1418>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2e9e:	ca650513          	addi	a0,a0,-858 # 6b40 <malloc+0x1630>
  ...
  if(unlink("dd") < 0){
    ...
    3010:	88450513          	addi	a0,a0,-1916 # 6890 <malloc+0x1380>
    3014:	444020ef          	jal	5458 <printf>
    exit(1);
    3018:	4505                	li	a0,1
    ...
    3024:	89050513          	addi	a0,a0,-1904 # 68b0 <malloc+0x13a0>
    3028:	430020ef          	jal	5458 <printf>
    exit(1);
    302c:	4505                	li	a0,1
    ...
    3038:	89c50513          	addi	a0,a0,-1892 # 68d0 <malloc+0x13c0>
    303c:	41c020ef          	jal	5458 <printf>
    exit(1);
    3040:	4505                	li	a0,1
    ...
    304c:	8c050513          	addi	a0,a0,-1856 # 6908 <malloc+0x13f8>
    3050:	408020ef          	jal	5458 <printf>
    exit(1);
    3054:	4505                	li	a0,1
    ...
    3060:	8dc50513          	addi	a0,a0,-1828 # 6938 <malloc+0x1428>
    3064:	3f4020ef          	jal	5458 <printf>
    exit(1);
    3068:	4505                	li	a0,1
    ...
    3074:	90050513          	addi	a0,a0,-1792 # 6970 <malloc+0x1460>
    3078:	3e0020ef          	jal	5458 <printf>
    exit(1);
    307c:	4505                	li	a0,1
    ...
    3088:	90c50513          	addi	a0,a0,-1780 # 6990 <malloc+0x1480>
    308c:	3cc020ef          	jal	5458 <printf>
    exit(1);
    3090:	4505                	li	a0,1
    ...
    309c:	92850513          	addi	a0,a0,-1752 # 69c0 <malloc+0x14b0>
    30a0:	3b8020ef          	jal	5458 <printf>
    exit(1);
    30a4:	4505                	li	a0,1
    ...
    30b0:	93c50513          	addi	a0,a0,-1732 # 69e8 <malloc+0x14d8>
    30b4:	3a4020ef          	jal	5458 <printf>
    exit(1);
    30b8:	4505                	li	a0,1
    ...
    30c4:	94850513          	addi	a0,a0,-1720 # 6a08 <malloc+0x14f8>
    30c8:	390020ef          	jal	5458 <printf>
    exit(1);
    30cc:	4505                	li	a0,1
    ...
    30d8:	95c50513          	addi	a0,a0,-1700 # 6a30 <malloc+0x1520>
    30dc:	37c020ef          	jal	5458 <printf>
    exit(1);
    30e0:	4505                	li	a0,1
    ...
    30ec:	97050513          	addi	a0,a0,-1680 # 6a58 <malloc+0x1548>
    30f0:	368020ef          	jal	5458 <printf>
    exit(1);
    30f4:	4505                	li	a0,1
    ...
    3100:	98c50513          	addi	a0,a0,-1652 # 6a88 <malloc+0x1578>
    3104:	354020ef          	jal	5458 <printf>
    exit(1);
    3108:	4505                	li	a0,1
    ...
    3114:	9a850513          	addi	a0,a0,-1624 # 6ab8 <malloc+0x15a8>
    3118:	340020ef          	jal	5458 <printf>
    exit(1);
    311c:	4505                	li	a0,1
    ...
    3128:	9ac50513          	addi	a0,a0,-1620 # 6ad0 <malloc+0x15c0>
    312c:	32c020ef          	jal	5458 <printf>
    exit(1);
    3130:	4505                	li	a0,1
    ...
    313c:	9b850513          	addi	a0,a0,-1608 # 6af0 <malloc+0x15e0>
    3140:	318020ef          	jal	5458 <printf>
    exit(1);
    3144:	4505                	li	a0,1
    ...
    3150:	9c450513          	addi	a0,a0,-1596 # 6b10 <malloc+0x1600>
    3154:	304020ef          	jal	5458 <printf>
    exit(1);
    3158:	4505                	li	a0,1
    ...
    3164:	9f050513          	addi	a0,a0,-1552 # 6b50 <malloc+0x1640>
    3168:	2f0020ef          	jal	5458 <printf>
    exit(1);
    316c:	4505                	li	a0,1
    ...
    3178:	a0c50513          	addi	a0,a0,-1524 # 6b80 <malloc+0x1670>
    317c:	2dc020ef          	jal	5458 <printf>
    exit(1);
    3180:	4505                	li	a0,1
    ...
    318c:	a1850513          	addi	a0,a0,-1512 # 6ba0 <malloc+0x1690>
    3190:	2c8020ef          	jal	5458 <printf>
    exit(1);
    3194:	4505                	li	a0,1
    ...
    31a0:	a2450513          	addi	a0,a0,-1500 # 6bc0 <malloc+0x16b0>
    31a4:	2b4020ef          	jal	5458 <printf>
    exit(1);
    31a8:	4505                	li	a0,1
    ...
    31b4:	a3050513          	addi	a0,a0,-1488 # 6be0 <malloc+0x16d0>
    31b8:	2a0020ef          	jal	5458 <printf>
    exit(1);
    31bc:	4505                	li	a0,1
    ...
    31c8:	a4c50513          	addi	a0,a0,-1460 # 6c10 <malloc+0x1700>
    31cc:	28c020ef          	jal	5458 <printf>
    exit(1);
    31d0:	4505                	li	a0,1
    ...
    31dc:	a6050513          	addi	a0,a0,-1440 # 6c38 <malloc+0x1728>
    31e0:	278020ef          	jal	5458 <printf>
    exit(1);
    31e4:	4505                	li	a0,1
    ...
    31f0:	a7450513          	addi	a0,a0,-1420 # 6c60 <malloc+0x1750>
    31f4:	264020ef          	jal	5458 <printf>
    exit(1);
    31f8:	4505                	li	a0,1
    ...
    3204:	a8850513          	addi	a0,a0,-1400 # 6c88 <malloc+0x1778>
    3208:	250020ef          	jal	5458 <printf>
    exit(1);
    320c:	4505                	li	a0,1
    ...
    3218:	a9450513          	addi	a0,a0,-1388 # 6ca8 <malloc+0x1798>
    321c:	23c020ef          	jal	5458 <printf>
    exit(1);
    3220:	4505                	li	a0,1
    ...
    322c:	aa050513          	addi	a0,a0,-1376 # 6cc8 <malloc+0x17b8>
    3230:	228020ef          	jal	5458 <printf>
    exit(1);
    3234:	4505                	li	a0,1
    ...
    3240:	ab450513          	addi	a0,a0,-1356 # 6cf0 <malloc+0x17e0>
    3244:	214020ef          	jal	5458 <printf>
    exit(1);
    3248:	4505                	li	a0,1
    ...
    3254:	ac050513          	addi	a0,a0,-1344 # 6d10 <malloc+0x1800>
    3258:	200020ef          	jal	5458 <printf>
    exit(1);
    325c:	4505                	li	a0,1
    ...
    3268:	acc50513          	addi	a0,a0,-1332 # 6d30 <malloc+0x1820>
    326c:	1ec020ef          	jal	5458 <printf>
    exit(1);
    3270:	4505                	li	a0,1
    ...
    327c:	ae050513          	addi	a0,a0,-1312 # 6d58 <malloc+0x1848>
    3280:	1d8020ef          	jal	5458 <printf>
    exit(1);
    3284:	4505                	li	a0,1
    ...
    3290:	75c50513          	addi	a0,a0,1884 # 69e8 <malloc+0x14d8>
    3294:	1c4020ef          	jal	5458 <printf>
    exit(1);
    3298:	4505                	li	a0,1
    ...
    32a4:	ad850513          	addi	a0,a0,-1320 # 6d78 <malloc+0x1868>
    32a8:	1b0020ef          	jal	5458 <printf>
    exit(1);
    32ac:	4505                	li	a0,1
    ...
    32b8:	ae450513          	addi	a0,a0,-1308 # 6d98 <malloc+0x1888>
    32bc:	19c020ef          	jal	5458 <printf>
    exit(1);
    32c0:	4505                	li	a0,1
    ...
    32cc:	b0050513          	addi	a0,a0,-1280 # 6dc8 <malloc+0x18b8>
    32d0:	188020ef          	jal	5458 <printf>
    exit(1);
    32d4:	4505                	li	a0,1
    ...
    32e0:	b0c50513          	addi	a0,a0,-1268 # 6de8 <malloc+0x18d8>
    32e4:	174020ef          	jal	5458 <printf>
    exit(1);
    32e8:	4505                	li	a0,1
...
00000000000032ee <rmdot>:
{
  ...
  if(unlink("dots") != 0){
    ...
    337a:	a9250513          	addi	a0,a0,-1390 # 6e08 <malloc+0x18f8>
    337e:	0da020ef          	jal	5458 <printf>
    exit(1);
    3382:	4505                	li	a0,1
    ...
    338e:	a9650513          	addi	a0,a0,-1386 # 6e20 <malloc+0x1910>
    3392:	0c6020ef          	jal	5458 <printf>
    exit(1);
    3396:	4505                	li	a0,1
    ...
    33a2:	a9a50513          	addi	a0,a0,-1382 # 6e38 <malloc+0x1928>
    33a6:	0b2020ef          	jal	5458 <printf>
    exit(1);
    33aa:	4505                	li	a0,1
    ...
    33b6:	a9e50513          	addi	a0,a0,-1378 # 6e50 <malloc+0x1940>
    33ba:	09e020ef          	jal	5458 <printf>
    exit(1);
    33be:	4505                	li	a0,1
    ...
    33ca:	43a50513          	addi	a0,a0,1082 # 6800 <malloc+0x12f0>
    33ce:	08a020ef          	jal	5458 <printf>
    exit(1);
    33d2:	4505                	li	a0,1
    ...
    33de:	a9650513          	addi	a0,a0,-1386 # 6e70 <malloc+0x1960>
    33e2:	076020ef          	jal	5458 <printf>
    exit(1);
    33e6:	4505                	li	a0,1
    ...
    33f2:	aaa50513          	addi	a0,a0,-1366 # 6e98 <malloc+0x1988>
    33f6:	062020ef          	jal	5458 <printf>
    exit(1);
    33fa:	4505                	li	a0,1
    ...
    3406:	ab650513          	addi	a0,a0,-1354 # 6eb8 <malloc+0x19a8>
    340a:	04e020ef          	jal	5458 <printf>
    exit(1);
    340e:	4505                	li	a0,1
...
0000000000003414 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    342a:	ab250513          	addi	a0,a0,-1358 # 6ed8 <malloc+0x19c8>
  ...
  if(chdir("dirfile") == 0){
    ...
    343e:	a9e50513          	addi	a0,a0,-1378 # 6ed8 <malloc+0x19c8>
    3442:	419010ef          	jal	505a <chdir>
    3446:	c569                	beqz	a0,3510 <dirfile+0xfc>
  fd = open("dirfile/xx", 0);
    3448:	4581                	li	a1,0
    344a:	00004517          	auipc	a0,0x4
    344e:	ad650513          	addi	a0,a0,-1322 # 6f20 <malloc+0x1a10>
  ...
  fd = open(".", 0);
    ...
    34ce:	86650513          	addi	a0,a0,-1946 # 5d30 <malloc+0x820>
    34d2:	359010ef          	jal	502a <open>
    34d6:	84aa                	mv	s1,a0
  if(write(fd, "x", 1) > 0){
    34d8:	4605                	li	a2,1
    34da:	00002597          	auipc	a1,0x2
    34de:	1de58593          	addi	a1,a1,478 # 56b8 <malloc+0x1a8>
  ...
  close(fd);
    ...
    3502:	9e250513          	addi	a0,a0,-1566 # 6ee0 <malloc+0x19d0>
    3506:	753010ef          	jal	5458 <printf>
    exit(1);
    350a:	4505                	li	a0,1
    ...
    3516:	9ee50513          	addi	a0,a0,-1554 # 6f00 <malloc+0x19f0>
    351a:	73f010ef          	jal	5458 <printf>
    exit(1);
    351e:	4505                	li	a0,1
    ...
    352a:	a0a50513          	addi	a0,a0,-1526 # 6f30 <malloc+0x1a20>
    352e:	72b010ef          	jal	5458 <printf>
    exit(1);
    3532:	4505                	li	a0,1
    ...
    353e:	9f650513          	addi	a0,a0,-1546 # 6f30 <malloc+0x1a20>
    3542:	717010ef          	jal	5458 <printf>
    exit(1);
    3546:	4505                	li	a0,1
    ...
    3552:	a0a50513          	addi	a0,a0,-1526 # 6f58 <malloc+0x1a48>
    3556:	703010ef          	jal	5458 <printf>
    exit(1);
    355a:	4505                	li	a0,1
    ...
    3566:	a1e50513          	addi	a0,a0,-1506 # 6f80 <malloc+0x1a70>
    356a:	6ef010ef          	jal	5458 <printf>
    exit(1);
    356e:	4505                	li	a0,1
    ...
    357a:	a3250513          	addi	a0,a0,-1486 # 6fa8 <malloc+0x1a98>
    357e:	6db010ef          	jal	5458 <printf>
    exit(1);
    3582:	4505                	li	a0,1
    ...
    358e:	a4650513          	addi	a0,a0,-1466 # 6fd0 <malloc+0x1ac0>
    3592:	6c7010ef          	jal	5458 <printf>
    exit(1);
    3596:	4505                	li	a0,1
    ...
    35a2:	a5250513          	addi	a0,a0,-1454 # 6ff0 <malloc+0x1ae0>
    35a6:	6b3010ef          	jal	5458 <printf>
    exit(1);
    35aa:	4505                	li	a0,1
    ...
    35b6:	a6650513          	addi	a0,a0,-1434 # 7018 <malloc+0x1b08>
    35ba:	69f010ef          	jal	5458 <printf>
    exit(1);
    35be:	4505                	li	a0,1
...
00000000000035c4 <iref>:
{
    ...
    35e4:	a50a8a93          	addi	s5,s5,-1456 # 7030 <malloc+0x1b20>
    mkdir("");
    35e8:	00003497          	auipc	s1,0x3
    35ec:	55048493          	addi	s1,s1,1360 # 6b38 <malloc+0x1628>
    link("README", "");
    35f0:	00002b17          	auipc	s6,0x2
    35f4:	230b0b13          	addi	s6,s6,560 # 5820 <malloc+0x310>
    fd = open("", O_CREATE);
    35f8:	20000a13          	li	s4,512
    fd = open("xx", O_CREATE);
    35fc:	00004997          	auipc	s3,0x4
    3600:	92c98993          	addi	s3,s3,-1748 # 6f28 <malloc+0x1a18>
    3604:	a835                	j	3640 <iref+0x7c>
      printf("%s: mkdir irefd failed\n", s);
    3606:	85de                	mv	a1,s7
    3608:	00004517          	auipc	a0,0x4
    360c:	a3050513          	addi	a0,a0,-1488 # 7038 <malloc+0x1b28>
    3610:	649010ef          	jal	5458 <printf>
      exit(1);
    3614:	4505                	li	a0,1
    ...
    3620:	a3450513          	addi	a0,a0,-1484 # 7050 <malloc+0x1b40>
    3624:	635010ef          	jal	5458 <printf>
      exit(1);
    3628:	4505                	li	a0,1
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    3684:	1d098993          	addi	s3,s3,464 # 6850 <malloc+0x1340>
    unlink("irefd");
    3688:	00004917          	auipc	s2,0x4
    368c:	9a890913          	addi	s2,s2,-1624 # 7030 <malloc+0x1b20>
    chdir("..");
    3690:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    36a4:	15850513          	addi	a0,a0,344 # 67f8 <malloc+0x12e8>
...
00000000000036c2 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    36d2:	99a50513          	addi	a0,a0,-1638 # 7068 <malloc+0x1b58>
  ...
  if(pid == 0){
    ...
    36ee:	97e50513          	addi	a0,a0,-1666 # 7068 <malloc+0x1b58>
    ...
    3700:	98c50513          	addi	a0,a0,-1652 # 7088 <malloc+0x1b78>
    3704:	555010ef          	jal	5458 <printf>
      exit(1);
    3708:	4505                	li	a0,1
    ...
    3714:	96050513          	addi	a0,a0,-1696 # 7070 <malloc+0x1b60>
    3718:	541010ef          	jal	5458 <printf>
    exit(1);
    371c:	4505                	li	a0,1
    ...
    3728:	7b450513          	addi	a0,a0,1972 # 5ed8 <malloc+0x9c8>
    372c:	52d010ef          	jal	5458 <printf>
    exit(1);
    3730:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    3746:	92650513          	addi	a0,a0,-1754 # 7068 <malloc+0x1b58>
    374a:	0f1010ef          	jal	503a <unlink>
    374e:	c919                	beqz	a0,3764 <openiputtest+0xa2>
    printf("%s: unlink failed\n", s);
    3750:	85a6                	mv	a1,s1
    3752:	00003517          	auipc	a0,0x3
    3756:	97650513          	addi	a0,a0,-1674 # 60c8 <malloc+0xbb8>
    375a:	4ff010ef          	jal	5458 <printf>
    exit(1);
    375e:	4505                	li	a0,1
...
0000000000003774 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    3784:	93050513          	addi	a0,a0,-1744 # 70b0 <malloc+0x1ba0>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    37a4:	91050513          	addi	a0,a0,-1776 # 70b0 <malloc+0x1ba0>
  ...
  pause(10); // one second
    ...
    37cc:	8d050513          	addi	a0,a0,-1840 # 6098 <malloc+0xb88>
    37d0:	489010ef          	jal	5458 <printf>
    exit(1);
    37d4:	4505                	li	a0,1
    ...
    37e0:	8d450513          	addi	a0,a0,-1836 # 70b0 <malloc+0x1ba0>
    ...
    37fc:	8b850513          	addi	a0,a0,-1864 # 70b0 <malloc+0x1ba0>
...
0000000000003810 <killstatus>:
{
  ...
  exit(0);
    ...
    386a:	67250513          	addi	a0,a0,1650 # 5ed8 <malloc+0x9c8>
    386e:	3eb010ef          	jal	5458 <printf>
      exit(1);
    3872:	4505                	li	a0,1
    ...
    3884:	84050513          	addi	a0,a0,-1984 # 70c0 <malloc+0x1bb0>
    3888:	3d1010ef          	jal	5458 <printf>
       exit(1);
    388c:	4505                	li	a0,1
...
0000000000003892 <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    38b8:	7e450513          	addi	a0,a0,2020 # 6098 <malloc+0xb88>
    38bc:	39d010ef          	jal	5458 <printf>
    exit(1);
    38c0:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    38da:	60250513          	addi	a0,a0,1538 # 5ed8 <malloc+0x9c8>
    38de:	37b010ef          	jal	5458 <printf>
    exit(1);
    38e2:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    390a:	db258593          	addi	a1,a1,-590 # 56b8 <malloc+0x1a8>
    ...
    392c:	5b050513          	addi	a0,a0,1456 # 5ed8 <malloc+0x9c8>
    3930:	329010ef          	jal	5458 <printf>
     exit(1);
    3934:	4505                	li	a0,1
    ...
    3940:	7a450513          	addi	a0,a0,1956 # 70e0 <malloc+0x1bd0>
    3944:	315010ef          	jal	5458 <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    3970:	78c50513          	addi	a0,a0,1932 # 70f8 <malloc+0x1be8>
    3974:	2e5010ef          	jal	5458 <printf>
}
  ...
  printf("kill... ");
    ...
    3994:	78050513          	addi	a0,a0,1920 # 7110 <malloc+0x1c00>
    3998:	2c1010ef          	jal	5458 <printf>
  kill(pid1);
    399c:	8526                	mv	a0,s1
  ...
  printf("wait... ");
    ...
    39b2:	77250513          	addi	a0,a0,1906 # 7120 <malloc+0x1c10>
    39b6:	2a3010ef          	jal	5458 <printf>
  wait(0);
    39ba:	4501                	li	a0,0
...
00000000000039ce <reparent>:
{
  ...
  exit(0);
    ...
    3a12:	4ca50513          	addi	a0,a0,1226 # 5ed8 <malloc+0x9c8>
    3a16:	243010ef          	jal	5458 <printf>
      exit(1);
    3a1a:	4505                	li	a0,1
    ...
    3a26:	63e50513          	addi	a0,a0,1598 # 6060 <malloc+0xb50>
    3a2a:	22f010ef          	jal	5458 <printf>
        exit(1);
    3a2e:	4505                	li	a0,1
...
0000000000003a4e <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    3a8e:	55650513          	addi	a0,a0,1366 # 5fe0 <malloc+0xad0>
    3a92:	1c7010ef          	jal	5458 <printf>
    exit(1);
    3a96:	4505                	li	a0,1
    ...
    3ab8:	df458593          	addi	a1,a1,-524 # 78a8 <malloc+0x2398>
    ...
    3ad6:	65e58593          	addi	a1,a1,1630 # 7130 <malloc+0x1c20>
  ...
  c = sbrk(PGSIZE);
    ...
    3b30:	60c50513          	addi	a0,a0,1548 # 7138 <malloc+0x1c28>
    3b34:	125010ef          	jal	5458 <printf>
  ...
  if(pid == 0){
    ...
    3b7a:	61250513          	addi	a0,a0,1554 # 7188 <malloc+0x1c78>
    3b7e:	0db010ef          	jal	5458 <printf>
    exit(1);
    3b82:	4505                	li	a0,1
    ...
    3b8e:	5de50513          	addi	a0,a0,1502 # 7168 <malloc+0x1c58>
    3b92:	0c7010ef          	jal	5458 <printf>
    exit(1);
    3b96:	4505                	li	a0,1
    ...
    3ba2:	33a50513          	addi	a0,a0,826 # 5ed8 <malloc+0x9c8>
    3ba6:	0b3010ef          	jal	5458 <printf>
    exit(1);
    3baa:	4505                	li	a0,1
...
0000000000003be2 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    3c26:	6084                	ld	s1,0(s1)
      free(m1);
    3c28:	063010ef          	jal	548a <free>
    while(m1){
    3c2c:	fce5                	bnez	s1,3c24 <mem+0x42>
    m1 = malloc(1024*20);
    3c2e:	6515                	lui	a0,0x5
    3c30:	0e1010ef          	jal	5510 <malloc>
    if(m1 == 0){
    3c34:	c511                	beqz	a0,3c40 <mem+0x5e>
    free(m1);
    3c36:	055010ef          	jal	548a <free>
    exit(0);
    3c3a:	4501                	li	a0,0
    ...
    3c46:	57650513          	addi	a0,a0,1398 # 71b8 <malloc+0x1ca8>
    3c4a:	00f010ef          	jal	5458 <printf>
      exit(1);
    3c4e:	4505                	li	a0,1
...
0000000000003c5a <sharedfd>:
{
  ...
  unlink("sharedfd");
    ...
    3c6e:	56e50513          	addi	a0,a0,1390 # 71d8 <malloc+0x1cc8>
    3c72:	3c8010ef          	jal	503a <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
    3c76:	20200593          	li	a1,514
    3c7a:	00003517          	auipc	a0,0x3
    3c7e:	55e50513          	addi	a0,a0,1374 # 71d8 <malloc+0x1cc8>
  ...
  if(pid == 0) {
    ...
    3ce6:	50650513          	addi	a0,a0,1286 # 71e8 <malloc+0x1cd8>
    3cea:	76e010ef          	jal	5458 <printf>
    exit(1);
    3cee:	4505                	li	a0,1
    ...
    3cfc:	51850513          	addi	a0,a0,1304 # 7210 <malloc+0x1d00>
    3d00:	758010ef          	jal	5458 <printf>
      exit(1);
    3d04:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    3d30:	4ac50513          	addi	a0,a0,1196 # 71d8 <malloc+0x1cc8>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    3d68:	4cc50513          	addi	a0,a0,1228 # 7230 <malloc+0x1d20>
    3d6c:	6ec010ef          	jal	5458 <printf>
    exit(1);
    3d70:	4505                	li	a0,1
  ...
  unlink("sharedfd");
    ...
    3d98:	44450513          	addi	a0,a0,1092 # 71d8 <malloc+0x1cc8>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    3dba:	4a250513          	addi	a0,a0,1186 # 7258 <malloc+0x1d48>
    3dbe:	69a010ef          	jal	5458 <printf>
    exit(1);
    3dc2:	4505                	li	a0,1
...
0000000000003dc8 <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    3dec:	48878793          	addi	a5,a5,1160 # 7270 <malloc+0x1d60>
    3df0:	f6f43823          	sd	a5,-144(s0)
    3df4:	00003797          	auipc	a5,0x3
    3df8:	48478793          	addi	a5,a5,1156 # 7278 <malloc+0x1d68>
    3dfc:	f6f43c23          	sd	a5,-136(s0)
    3e00:	00003797          	auipc	a5,0x3
    3e04:	48078793          	addi	a5,a5,1152 # 7280 <malloc+0x1d70>
    3e08:	f8f43023          	sd	a5,-128(s0)
    3e0c:	00003797          	auipc	a5,0x3
    3e10:	47c78793          	addi	a5,a5,1148 # 7288 <malloc+0x1d78>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    3e76:	06650513          	addi	a0,a0,102 # 5ed8 <malloc+0x9c8>
    3e7a:	5de010ef          	jal	5458 <printf>
      exit(1);
    3e7e:	4505                	li	a0,1
    ...
    3ed6:	09e50513          	addi	a0,a0,158 # 5f70 <malloc+0xa60>
    3eda:	57e010ef          	jal	5458 <printf>
        exit(1);
    3ede:	4505                	li	a0,1
    3ee0:	10a010ef          	jal	4fea <exit>
          printf("write failed %d\n", n);
    3ee4:	00003517          	auipc	a0,0x3
    3ee8:	3ac50513          	addi	a0,a0,940 # 7290 <malloc+0x1d80>
    3eec:	56c010ef          	jal	5458 <printf>
          exit(1);
    3ef0:	4505                	li	a0,1
    ...
    3f02:	3aa50513          	addi	a0,a0,938 # 72a8 <malloc+0x1d98>
    3f06:	552010ef          	jal	5458 <printf>
          exit(1);
    3f0a:	4505                	li	a0,1
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    3f6c:	35050513          	addi	a0,a0,848 # 72b8 <malloc+0x1da8>
    3f70:	4e8010ef          	jal	5458 <printf>
      exit(1);
    3f74:	4505                	li	a0,1
...
0000000000003f98 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    3fda:	2fac8c93          	addi	s9,s9,762 # 72d0 <malloc+0x1dc0>
      wait(&xstatus);
  ...
  for(i = 0; i < N; i++){
    ...
    402e:	2ae50513          	addi	a0,a0,686 # 72d8 <malloc+0x1dc8>
    4032:	426010ef          	jal	5458 <printf>
        exit(1);
    4036:	4505                	li	a0,1
    ...
    4044:	29050513          	addi	a0,a0,656 # 72d0 <malloc+0x1dc0>
  ...
  fd = open(".", 0);
    ...
    406c:	cc850513          	addi	a0,a0,-824 # 5d30 <malloc+0x820>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    40da:	22250513          	addi	a0,a0,546 # 72f8 <malloc+0x1de8>
    40de:	37a010ef          	jal	5458 <printf>
        exit(1);
    40e2:	4505                	li	a0,1
    ...
    40f2:	22a50513          	addi	a0,a0,554 # 7318 <malloc+0x1e08>
    40f6:	362010ef          	jal	5458 <printf>
        exit(1);
    40fa:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    4124:	22050513          	addi	a0,a0,544 # 7340 <malloc+0x1e30>
    4128:	330010ef          	jal	5458 <printf>
    exit(1);
    412c:	4505                	li	a0,1
    ...
    4138:	da450513          	addi	a0,a0,-604 # 5ed8 <malloc+0x9c8>
    413c:	31c010ef          	jal	5458 <printf>
      exit(1);
    4140:	4505                	li	a0,1
...
0000000000004278 <bigfile>:
{
  ...
  unlink("bigfile.dat");
    ...
    4292:	0ea50513          	addi	a0,a0,234 # 7378 <malloc+0x1e68>
    4296:	5a5000ef          	jal	503a <unlink>
  fd = open("bigfile.dat", O_CREATE | O_RDWR);
    429a:	20200593          	li	a1,514
    429e:	00003517          	auipc	a0,0x3
    42a2:	0da50513          	addi	a0,a0,218 # 7378 <malloc+0x1e68>
  ...
  fd = open("bigfile.dat", 0);
    ...
    42ea:	09250513          	addi	a0,a0,146 # 7378 <malloc+0x1e68>
  ...
  for(i = 0; ; i++){
    ...
    4344:	04850513          	addi	a0,a0,72 # 7388 <malloc+0x1e78>
    4348:	110010ef          	jal	5458 <printf>
    exit(1);
    434c:	4505                	li	a0,1
    ...
    4358:	05450513          	addi	a0,a0,84 # 73a8 <malloc+0x1e98>
    435c:	0fc010ef          	jal	5458 <printf>
      exit(1);
    4360:	4505                	li	a0,1
    ...
    436c:	06050513          	addi	a0,a0,96 # 73c8 <malloc+0x1eb8>
    4370:	0e8010ef          	jal	5458 <printf>
    exit(1);
    4374:	4505                	li	a0,1
    ...
    4380:	06c50513          	addi	a0,a0,108 # 73e8 <malloc+0x1ed8>
    4384:	0d4010ef          	jal	5458 <printf>
      exit(1);
    4388:	4505                	li	a0,1
    ...
    4394:	07850513          	addi	a0,a0,120 # 7408 <malloc+0x1ef8>
    4398:	0c0010ef          	jal	5458 <printf>
      exit(1);
    439c:	4505                	li	a0,1
    ...
    43a8:	07c50513          	addi	a0,a0,124 # 7420 <malloc+0x1f10>
    43ac:	0ac010ef          	jal	5458 <printf>
      exit(1);
    43b0:	4505                	li	a0,1
  ...
  unlink("bigfile.dat");
    ...
    43ca:	fb250513          	addi	a0,a0,-78 # 7378 <malloc+0x1e68>
    ...
    43ec:	05850513          	addi	a0,a0,88 # 7440 <malloc+0x1f30>
    43f0:	068010ef          	jal	5458 <printf>
    exit(1);
    43f4:	4505                	li	a0,1
...
00000000000043fa <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    440a:	05a50513          	addi	a0,a0,90 # 7460 <malloc+0x1f50>
  ...
  fd = open("bigarg-ok", 0);
    ...
    4430:	03450513          	addi	a0,a0,52 # 7460 <malloc+0x1f50>
  ...
  close(fd);
    ...
    448e:	1be50513          	addi	a0,a0,446 # 5648 <malloc+0x138>
    4492:	391000ef          	jal	5022 <exec>
    fd = open("bigarg-ok", O_CREATE);
    4496:	20000593          	li	a1,512
    449a:	00003517          	auipc	a0,0x3
    449e:	fc650513          	addi	a0,a0,-58 # 7460 <malloc+0x1f50>
    ...
    44b6:	fbe50513          	addi	a0,a0,-66 # 7470 <malloc+0x1f60>
    44ba:	79f000ef          	jal	5458 <printf>
    exit(1);
    44be:	4505                	li	a0,1
    ...
    44ce:	fc650513          	addi	a0,a0,-58 # 7490 <malloc+0x1f80>
    44d2:	787000ef          	jal	5458 <printf>
    exit(1);
    44d6:	4505                	li	a0,1
...
00000000000044dc <lazy_alloc>:
{
  ...
  exit(0);
    ...
    4526:	f8e50513          	addi	a0,a0,-114 # 74b0 <malloc+0x1fa0>
    452a:	72f000ef          	jal	5458 <printf>
    exit(1);
    452e:	4505                	li	a0,1
    4530:	2bb000ef          	jal	4fea <exit>
      printf("failed to read value from memory\n");
    4534:	00003517          	auipc	a0,0x3
    4538:	f9450513          	addi	a0,a0,-108 # 74c8 <malloc+0x1fb8>
    453c:	71d000ef          	jal	5458 <printf>
      exit(1);
    4540:	4505                	li	a0,1
...
0000000000004546 <lazy_unmap>:
{
  ...
  exit(0);
    ...
    45b4:	f0050513          	addi	a0,a0,-256 # 74b0 <malloc+0x1fa0>
    45b8:	6a1000ef          	jal	5458 <printf>
    exit(1);
    45bc:	4505                	li	a0,1
    45be:	22d000ef          	jal	4fea <exit>
      printf("error forking\n");
    45c2:	00003517          	auipc	a0,0x3
    45c6:	f2e50513          	addi	a0,a0,-210 # 74f0 <malloc+0x1fe0>
    45ca:	68f000ef          	jal	5458 <printf>
      exit(1);
    45ce:	4505                	li	a0,1
    ...
    45ea:	f1a50513          	addi	a0,a0,-230 # 7500 <malloc+0x1ff0>
    45ee:	66b000ef          	jal	5458 <printf>
        exit(1);
    45f2:	4505                	li	a0,1
...
00000000000045f8 <lazy_copy>:
{
    ...
    4642:	eda50513          	addi	a0,a0,-294 # 7518 <malloc+0x2008>
    4646:	613000ef          	jal	5458 <printf>
      exit(1);
    464a:	4505                	li	a0,1
    464c:	19f000ef          	jal	4fea <exit>
  unsigned long bad[] = {
    4650:	00003797          	auipc	a5,0x3
    4654:	54078793          	addi	a5,a5,1344 # 7b90 <malloc+0x2680>
  ...
  for(int i = 0; i < sizeof(bad)/sizeof(bad[0]); i++){
    ...
    4684:	1a0a8a93          	addi	s5,s5,416 # 5820 <malloc+0x310>
    ...
    4694:	0a0b0b13          	addi	s6,s6,160 # 5730 <malloc+0x220>
    int fd = open("README", 0);
    4698:	4581                	li	a1,0
    469a:	8556                	mv	a0,s5
  ...
  exit(0);
    ...
    46f0:	e5c50513          	addi	a0,a0,-420 # 7548 <malloc+0x2038>
    46f4:	565000ef          	jal	5458 <printf>
    46f8:	4505                	li	a0,1
    46fa:	0f1000ef          	jal	4fea <exit>
    if(read(fd, (char*)bad[i], 512) >= 0) { printf("read succeeded\n");  exit(1); }
    46fe:	00003517          	auipc	a0,0x3
    4702:	e6250513          	addi	a0,a0,-414 # 7560 <malloc+0x2050>
    4706:	553000ef          	jal	5458 <printf>
    470a:	4505                	li	a0,1
    470c:	0df000ef          	jal	4fea <exit>
    if(fd < 0) { printf("cannot open junk\n"); exit(1); }
    4710:	00003517          	auipc	a0,0x3
    4714:	e6050513          	addi	a0,a0,-416 # 7570 <malloc+0x2060>
    4718:	541000ef          	jal	5458 <printf>
    471c:	4505                	li	a0,1
    471e:	0cd000ef          	jal	4fea <exit>
    if(write(fd, (char*)bad[i], 512) >= 0) { printf("write succeeded\n"); exit(1); }
    4722:	00003517          	auipc	a0,0x3
    4726:	e6650513          	addi	a0,a0,-410 # 7588 <malloc+0x2078>
    472a:	52f000ef          	jal	5458 <printf>
    472e:	4505                	li	a0,1
...
0000000000004734 <lazy_sbrk>:
{
  ...
  if (p1 < 0 || p1 != p) {
    ...
    4786:	e1e50513          	addi	a0,a0,-482 # 75a0 <malloc+0x2090>
    478a:	4cf000ef          	jal	5458 <printf>
    exit(1);
    478e:	4505                	li	a0,1
  ...
  if (p < 0 || (uint64)p != TRAPFRAME-PGSIZE) {
    ...
    47ae:	e2650513          	addi	a0,a0,-474 # 75d0 <malloc+0x20c0>
    47b2:	4a7000ef          	jal	5458 <printf>
    exit(1);
    47b6:	4505                	li	a0,1
  ...
  if (p[1] != 0) {
    ...
    47d4:	e3850513          	addi	a0,a0,-456 # 7608 <malloc+0x20f8>
    47d8:	481000ef          	jal	5458 <printf>
    exit(1);
    47dc:	4505                	li	a0,1
  ...
  if ((uint64)p != -1) {
    ...
    47f4:	e4050513          	addi	a0,a0,-448 # 7630 <malloc+0x2120>
    47f8:	461000ef          	jal	5458 <printf>
    exit(1);
    47fc:	4505                	li	a0,1
  ...
  if ((uint64)p != -1) {
    ...
    4814:	e4850513          	addi	a0,a0,-440 # 7658 <malloc+0x2148>
    4818:	441000ef          	jal	5458 <printf>
    exit(1);
    481c:	4505                	li	a0,1
...
0000000000004828 <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    484a:	e4250513          	addi	a0,a0,-446 # 7688 <malloc+0x2178>
    484e:	40b000ef          	jal	5458 <printf>
  for(nfiles = 0; ; nfiles++){
    4852:	4481                	li	s1,0
    name[0] = 'f';
    ...
    4900:	d9c50513          	addi	a0,a0,-612 # 7698 <malloc+0x2188>
    4904:	355000ef          	jal	5458 <printf>
    int fd = open(name, O_CREATE|O_RDWR);
    ...
    4920:	d8c50513          	addi	a0,a0,-628 # 76a8 <malloc+0x2198>
    4924:	335000ef          	jal	5458 <printf>
  while(nfiles >= 0){
  ...
  printf("fsfull test finished\n");
    ...
    49e4:	ce850513          	addi	a0,a0,-792 # 76c8 <malloc+0x21b8>
    49e8:	271000ef          	jal	5458 <printf>
}
    ...
    4a36:	c8650513          	addi	a0,a0,-890 # 76b8 <malloc+0x21a8>
    4a3a:	21f000ef          	jal	5458 <printf>
    close(fd);
    4a3e:	854a                	mv	a0,s2
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    4a60:	c8450513          	addi	a0,a0,-892 # 76e0 <malloc+0x21d0>
    4a64:	1f5000ef          	jal	5458 <printf>
  if((pid = fork()) < 0) {
  ...
  if(pid == 0) {
    ...
    4a84:	c8850513          	addi	a0,a0,-888 # 7708 <malloc+0x21f8>
    4a88:	1d1000ef          	jal	5458 <printf>
    else
      printf("OK\n");
    return xstatus == 0;
    ...
    4aa4:	c5050513          	addi	a0,a0,-944 # 76f0 <malloc+0x21e0>
    4aa8:	1b1000ef          	jal	5458 <printf>
    exit(1);
    4aac:	4505                	li	a0,1
    ...
    4ac0:	c5450513          	addi	a0,a0,-940 # 7710 <malloc+0x2200>
    4ac4:	195000ef          	jal	5458 <printf>
...
runtests(struct test *tests, char *justone, int continuous) {
  ...
  for (struct test *t = tests; t->s != 0; t++) {
    ...
    4b12:	c0a50513          	addi	a0,a0,-1014 # 7718 <malloc+0x2208>
    4b16:	143000ef          	jal	5458 <printf>
          return -1;
    4b1a:	59fd                	li	s3,-1
...
drivetests(int quick, int continuous, char *justone) {
    ...
    4bb0:	b84c0c13          	addi	s8,s8,-1148 # 7730 <malloc+0x2220>
    ...
    4bca:	ba2d8d93          	addi	s11,s11,-1118 # 7768 <malloc+0x2258>
    ...
    4bdc:	b7050513          	addi	a0,a0,-1168 # 7748 <malloc+0x2238>
    4be0:	079000ef          	jal	5458 <printf>
    ...
    4c4e:	b4e50513          	addi	a0,a0,-1202 # 7798 <malloc+0x2288>
    4c52:	007000ef          	jal	5458 <printf>
      return 1;
    4c56:	4505                	li	a0,1
  return 0;
}
...
main(int argc, char *argv[])
{
  ...
  if(argc == 2 && strcmp(argv[1], "-q") == 0){
    ...
    4cb4:	b0058593          	addi	a1,a1,-1280 # 77b0 <malloc+0x22a0>
  ...
  int continuous = 0;
    ...
    4d08:	abc50513          	addi	a0,a0,-1348 # 77c0 <malloc+0x22b0>
    4d0c:	74c000ef          	jal	5458 <printf>
    exit(1);
    4d10:	4505                	li	a0,1
  ...
  printf("ALL TESTS PASSED\n");
    ...
    4d26:	ace50513          	addi	a0,a0,-1330 # 77f0 <malloc+0x22e0>
    4d2a:	72e000ef          	jal	5458 <printf>
  exit(0);
    4d2e:	4501                	li	a0,0
...
00000000000050aa <check_deadlock>:
...
putc(int fd, char c)
{
    50b2:	1101                	addi	sp,sp,-32
    50b4:	ec06                	sd	ra,24(sp)
    50b6:	e822                	sd	s0,16(sp)
    50b8:	1000                	addi	s0,sp,32
    50ba:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
    50be:	4605                	li	a2,1
    50c0:	fef40593          	addi	a1,s0,-17
    50c4:	f47ff0ef          	jal	500a <write>
}
    50c8:	60e2                	ld	ra,24(sp)
    50ca:	6442                	ld	s0,16(sp)
    50cc:	6105                	addi	sp,sp,32
    50ce:	8082                	ret

00000000000050d0 <printint>:

static void
printint(int fd, long long xx, int base, int sgn)
{
    50d0:	715d                	addi	sp,sp,-80
    50d2:	e486                	sd	ra,72(sp)
    50d4:	e0a2                	sd	s0,64(sp)
    50d6:	f84a                	sd	s2,48(sp)
    50d8:	f44e                	sd	s3,40(sp)
    50da:	0880                	addi	s0,sp,80
    50dc:	892a                	mv	s2,a0
  char buf[20];
  int i, neg;
  ...
  neg = 0;
  if(sgn && xx < 0){
    50de:	c6d1                	beqz	a3,516a <printint+0x9a>
    50e0:	0805d563          	bgez	a1,516a <printint+0x9a>
    neg = 1;
    x = -xx;
    50e4:	40b005b3          	neg	a1,a1
    neg = 1;
    50e8:	4305                	li	t1,1
  } else {
    x = xx;
  ...
  do{
    buf[i++] = digits[x % base];
    50f2:	00003817          	auipc	a6,0x3
    50f6:	b4680813          	addi	a6,a6,-1210 # 7c38 <digits>
    50fa:	88ba                	mv	a7,a4
    50fc:	0017051b          	addiw	a0,a4,1
    5100:	872a                	mv	a4,a0
    5102:	02c5f7b3          	remu	a5,a1,a2
    5106:	97c2                	add	a5,a5,a6
    5108:	0007c783          	lbu	a5,0(a5)
    510c:	00f68023          	sb	a5,0(a3)
  }while((x /= base) != 0);
    5110:	87ae                	mv	a5,a1
    5112:	02c5d5b3          	divu	a1,a1,a2
    5116:	0685                	addi	a3,a3,1
    5118:	fec7f1e3          	bgeu	a5,a2,50fa <printint+0x2a>
  if(neg)
    511c:	00030c63          	beqz	t1,5134 <printint+0x64>
    buf[i++] = '-';
    5120:	fd050793          	addi	a5,a0,-48
    5124:	00878533          	add	a0,a5,s0
    5128:	02d00793          	li	a5,45
    512c:	fef50423          	sb	a5,-24(a0)
    5130:	0028871b          	addiw	a4,a7,2

  while(--i >= 0)
    5134:	02e05563          	blez	a4,515e <printint+0x8e>
    5138:	fc26                	sd	s1,56(sp)
    513a:	377d                	addiw	a4,a4,-1
    513c:	00e984b3          	add	s1,s3,a4
    5140:	19fd                	addi	s3,s3,-1 # fff <bigdir+0x10b>
    5142:	99ba                	add	s3,s3,a4
    5144:	1702                	slli	a4,a4,0x20
    5146:	9301                	srli	a4,a4,0x20
    5148:	40e989b3          	sub	s3,s3,a4
    putc(fd, buf[i]);
    514c:	0004c583          	lbu	a1,0(s1)
    5150:	854a                	mv	a0,s2
    5152:	f61ff0ef          	jal	50b2 <putc>
  while(--i >= 0)
    5156:	14fd                	addi	s1,s1,-1
    5158:	ff349ae3          	bne	s1,s3,514c <printint+0x7c>
    515c:	74e2                	ld	s1,56(sp)
}
    515e:	60a6                	ld	ra,72(sp)
    5160:	6406                	ld	s0,64(sp)
    5162:	7942                	ld	s2,48(sp)
    5164:	79a2                	ld	s3,40(sp)
    5166:	6161                	addi	sp,sp,80
    5168:	8082                	ret
  neg = 0;
    516a:	4301                	li	t1,0
    516c:	bfbd                	j	50ea <printint+0x1a>

000000000000516e <vprintf>:
}
...
{
    516e:	711d                	addi	sp,sp,-96
    5170:	ec86                	sd	ra,88(sp)
    5172:	e8a2                	sd	s0,80(sp)
    5174:	e4a6                	sd	s1,72(sp)
    5176:	1080                	addi	s0,sp,96
  char *s;
  int c0, c1, c2, i, state;

  state = 0;
  for(i = 0; fmt[i]; i++){
    5178:	0005c483          	lbu	s1,0(a1)
    517c:	22048363          	beqz	s1,53a2 <vprintf+0x234>
    5180:	e0ca                	sd	s2,64(sp)
    5182:	fc4e                	sd	s3,56(sp)
    5184:	f852                	sd	s4,48(sp)
    5186:	f456                	sd	s5,40(sp)
    5188:	f05a                	sd	s6,32(sp)
    518a:	ec5e                	sd	s7,24(sp)
    518c:	e862                	sd	s8,16(sp)
    518e:	8b2a                	mv	s6,a0
    5190:	8a2e                	mv	s4,a1
    5192:	8bb2                	mv	s7,a2
  state = 0;
  ...
  for(i = 0; fmt[i]; i++){
    ...
    519a:	02500a93          	li	s5,37
      c1 = c2 = 0;
      if(c0) c1 = fmt[i+1] & 0xff;
      if(c1) c2 = fmt[i+2] & 0xff;
      if(c0 == 'd'){
    519e:	06400c13          	li	s8,100
    51a2:	a00d                	j	51c4 <vprintf+0x56>
        putc(fd, c0);
    51a4:	85a6                	mv	a1,s1
    51a6:	855a                	mv	a0,s6
    51a8:	f0bff0ef          	jal	50b2 <putc>
    51ac:	a019                	j	51b2 <vprintf+0x44>
    } else if(state == '%'){
    51ae:	03598363          	beq	s3,s5,51d4 <vprintf+0x66>
  for(i = 0; fmt[i]; i++){
    51b2:	0019079b          	addiw	a5,s2,1
    51b6:	893e                	mv	s2,a5
    51b8:	873e                	mv	a4,a5
    51ba:	97d2                	add	a5,a5,s4
    51bc:	0007c483          	lbu	s1,0(a5)
    51c0:	1c048a63          	beqz	s1,5394 <vprintf+0x226>
    c0 = fmt[i] & 0xff;
    51c4:	0004879b          	sext.w	a5,s1
    if(state == 0){
    51c8:	fe0993e3          	bnez	s3,51ae <vprintf+0x40>
      if(c0 == '%'){
    51cc:	fd579ce3          	bne	a5,s5,51a4 <vprintf+0x36>
        state = '%';
    51d0:	89be                	mv	s3,a5
    51d2:	b7c5                	j	51b2 <vprintf+0x44>
      if(c0) c1 = fmt[i+1] & 0xff;
    51d4:	00ea06b3          	add	a3,s4,a4
    51d8:	0016c603          	lbu	a2,1(a3)
      if(c1) c2 = fmt[i+2] & 0xff;
    51dc:	1c060863          	beqz	a2,53ac <vprintf+0x23e>
      if(c0 == 'd'){
    51e0:	03878763          	beq	a5,s8,520e <vprintf+0xa0>
        printint(fd, va_arg(ap, int), 10, 1);
      } else if(c0 == 'l' && c1 == 'd'){
    51e4:	f9478693          	addi	a3,a5,-108
    51e8:	0016b693          	seqz	a3,a3
    51ec:	f9c60593          	addi	a1,a2,-100
    51f0:	e99d                	bnez	a1,5226 <vprintf+0xb8>
    51f2:	ca95                	beqz	a3,5226 <vprintf+0xb8>
        printint(fd, va_arg(ap, uint64), 10, 1);
    51f4:	008b8493          	addi	s1,s7,8
    51f8:	4685                	li	a3,1
    51fa:	4629                	li	a2,10
    51fc:	000bb583          	ld	a1,0(s7)
    5200:	855a                	mv	a0,s6
    5202:	ecfff0ef          	jal	50d0 <printint>
        i += 1;
    5206:	2905                	addiw	s2,s2,1
        printint(fd, va_arg(ap, uint64), 10, 1);
    5208:	8ba6                	mv	s7,s1
      ...
      state = 0;
    520a:	4981                	li	s3,0
    520c:	b75d                	j	51b2 <vprintf+0x44>
        printint(fd, va_arg(ap, int), 10, 1);
    520e:	008b8493          	addi	s1,s7,8
    5212:	4685                	li	a3,1
    5214:	4629                	li	a2,10
    5216:	000ba583          	lw	a1,0(s7)
    521a:	855a                	mv	a0,s6
    521c:	eb5ff0ef          	jal	50d0 <printint>
    5220:	8ba6                	mv	s7,s1
      state = 0;
    5222:	4981                	li	s3,0
    5224:	b779                	j	51b2 <vprintf+0x44>
      if(c1) c2 = fmt[i+2] & 0xff;
    5226:	9752                	add	a4,a4,s4
    5228:	00274583          	lbu	a1,2(a4)
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
    522c:	f9460713          	addi	a4,a2,-108
    5230:	00173713          	seqz	a4,a4
    5234:	8f75                	and	a4,a4,a3
    5236:	f9c58513          	addi	a0,a1,-100
    523a:	18051363          	bnez	a0,53c0 <vprintf+0x252>
    523e:	18070163          	beqz	a4,53c0 <vprintf+0x252>
        printint(fd, va_arg(ap, uint64), 10, 1);
    5242:	008b8493          	addi	s1,s7,8
    5246:	4685                	li	a3,1
    5248:	4629                	li	a2,10
    524a:	000bb583          	ld	a1,0(s7)
    524e:	855a                	mv	a0,s6
    5250:	e81ff0ef          	jal	50d0 <printint>
        i += 2;
    5254:	2909                	addiw	s2,s2,2
        printint(fd, va_arg(ap, uint64), 10, 1);
    5256:	8ba6                	mv	s7,s1
      state = 0;
    5258:	4981                	li	s3,0
        i += 2;
    525a:	bfa1                	j	51b2 <vprintf+0x44>
        printint(fd, va_arg(ap, uint32), 10, 0);
    525c:	008b8493          	addi	s1,s7,8
    5260:	4681                	li	a3,0
    5262:	4629                	li	a2,10
    5264:	000be583          	lwu	a1,0(s7)
    5268:	855a                	mv	a0,s6
    526a:	e67ff0ef          	jal	50d0 <printint>
    526e:	8ba6                	mv	s7,s1
      state = 0;
    5270:	4981                	li	s3,0
    5272:	b781                	j	51b2 <vprintf+0x44>
        printint(fd, va_arg(ap, uint64), 10, 0);
    5274:	008b8493          	addi	s1,s7,8
    5278:	4681                	li	a3,0
    527a:	4629                	li	a2,10
    527c:	000bb583          	ld	a1,0(s7)
    5280:	855a                	mv	a0,s6
    5282:	e4fff0ef          	jal	50d0 <printint>
        i += 1;
    5286:	2905                	addiw	s2,s2,1
        printint(fd, va_arg(ap, uint64), 10, 0);
    5288:	8ba6                	mv	s7,s1
      state = 0;
    528a:	4981                	li	s3,0
    528c:	b71d                	j	51b2 <vprintf+0x44>
        printint(fd, va_arg(ap, uint64), 10, 0);
    528e:	008b8493          	addi	s1,s7,8
    5292:	4681                	li	a3,0
    5294:	4629                	li	a2,10
    5296:	000bb583          	ld	a1,0(s7)
    529a:	855a                	mv	a0,s6
    529c:	e35ff0ef          	jal	50d0 <printint>
        i += 2;
    52a0:	2909                	addiw	s2,s2,2
        printint(fd, va_arg(ap, uint64), 10, 0);
    52a2:	8ba6                	mv	s7,s1
      state = 0;
    52a4:	4981                	li	s3,0
        i += 2;
    52a6:	b731                	j	51b2 <vprintf+0x44>
        printint(fd, va_arg(ap, uint32), 16, 0);
    52a8:	008b8493          	addi	s1,s7,8
    52ac:	4681                	li	a3,0
    52ae:	4641                	li	a2,16
    52b0:	000be583          	lwu	a1,0(s7)
    52b4:	855a                	mv	a0,s6
    52b6:	e1bff0ef          	jal	50d0 <printint>
    52ba:	8ba6                	mv	s7,s1
      state = 0;
    52bc:	4981                	li	s3,0
    52be:	bdd5                	j	51b2 <vprintf+0x44>
        printint(fd, va_arg(ap, uint64), 16, 0);
    52c0:	008b8493          	addi	s1,s7,8
    52c4:	4681                	li	a3,0
    52c6:	4641                	li	a2,16
    52c8:	000bb583          	ld	a1,0(s7)
    52cc:	855a                	mv	a0,s6
    52ce:	e03ff0ef          	jal	50d0 <printint>
        i += 1;
    52d2:	2905                	addiw	s2,s2,1
        printint(fd, va_arg(ap, uint64), 16, 0);
    52d4:	8ba6                	mv	s7,s1
      state = 0;
    52d6:	4981                	li	s3,0
    52d8:	bde9                	j	51b2 <vprintf+0x44>
        printint(fd, va_arg(ap, uint64), 16, 0);
    52da:	008b8493          	addi	s1,s7,8
    52de:	4681                	li	a3,0
    52e0:	4641                	li	a2,16
    52e2:	000bb583          	ld	a1,0(s7)
    52e6:	855a                	mv	a0,s6
    52e8:	de9ff0ef          	jal	50d0 <printint>
        i += 2;
    52ec:	2909                	addiw	s2,s2,2
        printint(fd, va_arg(ap, uint64), 16, 0);
    52ee:	8ba6                	mv	s7,s1
      state = 0;
    52f0:	4981                	li	s3,0
        i += 2;
    52f2:	b5c1                	j	51b2 <vprintf+0x44>
    52f4:	e466                	sd	s9,8(sp)
        printptr(fd, va_arg(ap, uint64));
    52f6:	008b8793          	addi	a5,s7,8
    52fa:	8cbe                	mv	s9,a5
    52fc:	000bb983          	ld	s3,0(s7)
  putc(fd, '0');
    5300:	03000593          	li	a1,48
    5304:	855a                	mv	a0,s6
    5306:	dadff0ef          	jal	50b2 <putc>
  putc(fd, 'x');
    530a:	07800593          	li	a1,120
    530e:	855a                	mv	a0,s6
    5310:	da3ff0ef          	jal	50b2 <putc>
    5314:	44c1                	li	s1,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    5316:	00003b97          	auipc	s7,0x3
    531a:	922b8b93          	addi	s7,s7,-1758 # 7c38 <digits>
    531e:	03c9d793          	srli	a5,s3,0x3c
    5322:	97de                	add	a5,a5,s7
    5324:	0007c583          	lbu	a1,0(a5)
    5328:	855a                	mv	a0,s6
    532a:	d89ff0ef          	jal	50b2 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    532e:	0992                	slli	s3,s3,0x4
    5330:	34fd                	addiw	s1,s1,-1
    5332:	f4f5                	bnez	s1,531e <vprintf+0x1b0>
        printptr(fd, va_arg(ap, uint64));
    5334:	8be6                	mv	s7,s9
      state = 0;
    5336:	4981                	li	s3,0
    5338:	6ca2                	ld	s9,8(sp)
    533a:	bda5                	j	51b2 <vprintf+0x44>
        putc(fd, va_arg(ap, uint32));
    533c:	008b8493          	addi	s1,s7,8
    5340:	000bc583          	lbu	a1,0(s7)
    5344:	855a                	mv	a0,s6
    5346:	d6dff0ef          	jal	50b2 <putc>
    534a:	8ba6                	mv	s7,s1
      state = 0;
    534c:	4981                	li	s3,0
    534e:	b595                	j	51b2 <vprintf+0x44>
        if((s = va_arg(ap, char*)) == 0)
    5350:	008b8993          	addi	s3,s7,8
    5354:	000bb483          	ld	s1,0(s7)
    5358:	cc91                	beqz	s1,5374 <vprintf+0x206>
        for(; *s; s++)
    535a:	0004c583          	lbu	a1,0(s1)
    535e:	c985                	beqz	a1,538e <vprintf+0x220>
          putc(fd, *s);
    5360:	855a                	mv	a0,s6
    5362:	d51ff0ef          	jal	50b2 <putc>
        for(; *s; s++)
    5366:	0485                	addi	s1,s1,1
    5368:	0004c583          	lbu	a1,0(s1)
    536c:	f9f5                	bnez	a1,5360 <vprintf+0x1f2>
        if((s = va_arg(ap, char*)) == 0)
    536e:	8bce                	mv	s7,s3
      state = 0;
    5370:	4981                	li	s3,0
    5372:	b581                	j	51b2 <vprintf+0x44>
          s = "(null)";
    5374:	00003497          	auipc	s1,0x3
    5378:	81448493          	addi	s1,s1,-2028 # 7b88 <malloc+0x2678>
        for(; *s; s++)
    537c:	02800593          	li	a1,40
    5380:	b7c5                	j	5360 <vprintf+0x1f2>
        putc(fd, '%');
    5382:	85be                	mv	a1,a5
    5384:	855a                	mv	a0,s6
    5386:	d2dff0ef          	jal	50b2 <putc>
      state = 0;
    538a:	4981                	li	s3,0
    538c:	b51d                	j	51b2 <vprintf+0x44>
        if((s = va_arg(ap, char*)) == 0)
    538e:	8bce                	mv	s7,s3
      state = 0;
    5390:	4981                	li	s3,0
    5392:	b505                	j	51b2 <vprintf+0x44>
    5394:	6906                	ld	s2,64(sp)
    5396:	79e2                	ld	s3,56(sp)
    5398:	7a42                	ld	s4,48(sp)
    539a:	7aa2                	ld	s5,40(sp)
    539c:	7b02                	ld	s6,32(sp)
    539e:	6be2                	ld	s7,24(sp)
    53a0:	6c42                	ld	s8,16(sp)
    }
  }
}
    53a2:	60e6                	ld	ra,88(sp)
    53a4:	6446                	ld	s0,80(sp)
    53a6:	64a6                	ld	s1,72(sp)
    53a8:	6125                	addi	sp,sp,96
    53aa:	8082                	ret
      if(c0 == 'd'){
    53ac:	06400713          	li	a4,100
    53b0:	e4e78fe3          	beq	a5,a4,520e <vprintf+0xa0>
      } else if(c0 == 'l' && c1 == 'd'){
    53b4:	f9478693          	addi	a3,a5,-108
    53b8:	0016b693          	seqz	a3,a3
      c1 = c2 = 0;
    53bc:	85b2                	mv	a1,a2
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
    53be:	4701                	li	a4,0
      } else if(c0 == 'u'){
    53c0:	07500513          	li	a0,117
    53c4:	e8a78ce3          	beq	a5,a0,525c <vprintf+0xee>
      } else if(c0 == 'l' && c1 == 'u'){
    53c8:	f8b60513          	addi	a0,a2,-117
    53cc:	e119                	bnez	a0,53d2 <vprintf+0x264>
    53ce:	ea0693e3          	bnez	a3,5274 <vprintf+0x106>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
    53d2:	f8b58513          	addi	a0,a1,-117
    53d6:	e119                	bnez	a0,53dc <vprintf+0x26e>
    53d8:	ea071be3          	bnez	a4,528e <vprintf+0x120>
      } else if(c0 == 'x'){
    53dc:	07800513          	li	a0,120
    53e0:	eca784e3          	beq	a5,a0,52a8 <vprintf+0x13a>
      } else if(c0 == 'l' && c1 == 'x'){
    53e4:	f8860613          	addi	a2,a2,-120
    53e8:	e219                	bnez	a2,53ee <vprintf+0x280>
    53ea:	ec069be3          	bnez	a3,52c0 <vprintf+0x152>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'x'){
    53ee:	f8858593          	addi	a1,a1,-120
    53f2:	e199                	bnez	a1,53f8 <vprintf+0x28a>
    53f4:	ee0713e3          	bnez	a4,52da <vprintf+0x16c>
      } else if(c0 == 'p'){
    53f8:	07000713          	li	a4,112
    53fc:	eee78ce3          	beq	a5,a4,52f4 <vprintf+0x186>
      } else if(c0 == 'c'){
    5400:	06300713          	li	a4,99
    5404:	f2e78ce3          	beq	a5,a4,533c <vprintf+0x1ce>
      } else if(c0 == 's'){
    5408:	07300713          	li	a4,115
    540c:	f4e782e3          	beq	a5,a4,5350 <vprintf+0x1e2>
      } else if(c0 == '%'){
    5410:	02500713          	li	a4,37
    5414:	f6e787e3          	beq	a5,a4,5382 <vprintf+0x214>
        putc(fd, '%');
    5418:	02500593          	li	a1,37
    541c:	855a                	mv	a0,s6
    541e:	c95ff0ef          	jal	50b2 <putc>
        putc(fd, c0);
    5422:	85a6                	mv	a1,s1
    5424:	855a                	mv	a0,s6
    5426:	c8dff0ef          	jal	50b2 <putc>
      state = 0;
    542a:	4981                	li	s3,0
    542c:	b359                	j	51b2 <vprintf+0x44>

000000000000542e <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    542e:	715d                	addi	sp,sp,-80
    5430:	ec06                	sd	ra,24(sp)
    5432:	e822                	sd	s0,16(sp)
    5434:	1000                	addi	s0,sp,32
    5436:	e010                	sd	a2,0(s0)
    5438:	e414                	sd	a3,8(s0)
    543a:	e818                	sd	a4,16(s0)
    543c:	ec1c                	sd	a5,24(s0)
    543e:	03043023          	sd	a6,32(s0)
    5442:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    5446:	8622                	mv	a2,s0
    5448:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    544c:	d23ff0ef          	jal	516e <vprintf>
}
    5450:	60e2                	ld	ra,24(sp)
    5452:	6442                	ld	s0,16(sp)
    5454:	6161                	addi	sp,sp,80
    5456:	8082                	ret

0000000000005458 <printf>:
...
printf(const char *fmt, ...)
{
    ...
    5460:	e40c                	sd	a1,8(s0)
    5462:	e810                	sd	a2,16(s0)
    5464:	ec14                	sd	a3,24(s0)
    5466:	f018                	sd	a4,32(s0)
    5468:	f41c                	sd	a5,40(s0)
    546a:	03043823          	sd	a6,48(s0)
    546e:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    5472:	00840613          	addi	a2,s0,8
    5476:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    547a:	85aa                	mv	a1,a0
    547c:	4505                	li	a0,1
    547e:	cf1ff0ef          	jal	516e <vprintf>
}
    5482:	60e2                	ld	ra,24(sp)
    5484:	6442                	ld	s0,16(sp)
    5486:	6125                	addi	sp,sp,96
    5488:	8082                	ret

000000000000548a <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
    ...
    548c:	e406                	sd	ra,8(sp)
    548e:	e022                	sd	s0,0(sp)
    5490:	0800                	addi	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    5492:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5496:	00003797          	auipc	a5,0x3
    549a:	ffa7b783          	ld	a5,-6(a5) # 8490 <freep>
    549e:	a039                	j	54ac <free+0x22>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    54a0:	6398                	ld	a4,0(a5)
    54a2:	00e7e463          	bltu	a5,a4,54aa <free+0x20>
    54a6:	00e6ea63          	bltu	a3,a4,54ba <free+0x30>
{
    54aa:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    54ac:	fed7fae3          	bgeu	a5,a3,54a0 <free+0x16>
    54b0:	6398                	ld	a4,0(a5)
    54b2:	00e6e463          	bltu	a3,a4,54ba <free+0x30>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    54b6:	fee7eae3          	bltu	a5,a4,54aa <free+0x20>
      break;
  if(bp + bp->s.size == p->s.ptr){
    54ba:	ff852583          	lw	a1,-8(a0)
    54be:	6390                	ld	a2,0(a5)
    54c0:	02059813          	slli	a6,a1,0x20
    54c4:	01c85713          	srli	a4,a6,0x1c
    54c8:	9736                	add	a4,a4,a3
    54ca:	02e60563          	beq	a2,a4,54f4 <free+0x6a>
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
    54ce:	fec53823          	sd	a2,-16(a0)
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    54d2:	4790                	lw	a2,8(a5)
    54d4:	02061593          	slli	a1,a2,0x20
    54d8:	01c5d713          	srli	a4,a1,0x1c
    54dc:	973e                	add	a4,a4,a5
    54de:	02e68263          	beq	a3,a4,5502 <free+0x78>
    p->s.size += bp->s.size;
    p->s.ptr = bp->s.ptr;
    54e2:	e394                	sd	a3,0(a5)
  } else
    p->s.ptr = bp;
  freep = p;
    54e4:	00003717          	auipc	a4,0x3
    54e8:	faf73623          	sd	a5,-84(a4) # 8490 <freep>
}
    ...
    54f2:	8082                	ret
    bp->s.size += p->s.ptr->s.size;
    54f4:	4618                	lw	a4,8(a2)
    54f6:	9f2d                	addw	a4,a4,a1
    54f8:	fee52c23          	sw	a4,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    54fc:	6398                	ld	a4,0(a5)
    54fe:	6310                	ld	a2,0(a4)
    5500:	b7f9                	j	54ce <free+0x44>
    p->s.size += bp->s.size;
    5502:	ff852703          	lw	a4,-8(a0)
    5506:	9f31                	addw	a4,a4,a2
    5508:	c798                	sw	a4,8(a5)
    p->s.ptr = bp->s.ptr;
    550a:	ff053683          	ld	a3,-16(a0)
    550e:	bfd1                	j	54e2 <free+0x58>

0000000000005510 <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
    5510:	7139                	addi	sp,sp,-64
    5512:	fc06                	sd	ra,56(sp)
    5514:	f822                	sd	s0,48(sp)
    5516:	f04a                	sd	s2,32(sp)
    5518:	ec4e                	sd	s3,24(sp)
    551a:	0080                	addi	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    551c:	02051993          	slli	s3,a0,0x20
    5520:	0209d993          	srli	s3,s3,0x20
    5524:	09bd                	addi	s3,s3,15
    5526:	0049d993          	srli	s3,s3,0x4
    552a:	2985                	addiw	s3,s3,1
    552c:	894e                	mv	s2,s3
  if((prevp = freep) == 0){
    552e:	00003517          	auipc	a0,0x3
    5532:	f6253503          	ld	a0,-158(a0) # 8490 <freep>
    5536:	c905                	beqz	a0,5566 <malloc+0x56>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    5538:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    553a:	4798                	lw	a4,8(a5)
    553c:	09377663          	bgeu	a4,s3,55c8 <malloc+0xb8>
    5540:	f426                	sd	s1,40(sp)
    5542:	e852                	sd	s4,16(sp)
    5544:	e456                	sd	s5,8(sp)
    5546:	e05a                	sd	s6,0(sp)
  if(nu < 4096)
    5548:	8a4e                	mv	s4,s3
    554a:	6705                	lui	a4,0x1
    554c:	00e9f363          	bgeu	s3,a4,5552 <malloc+0x42>
    5550:	6a05                	lui	s4,0x1
    5552:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    5556:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    555a:	00003497          	auipc	s1,0x3
    555e:	f3648493          	addi	s1,s1,-202 # 8490 <freep>
  if(p == SBRK_ERROR)
    5562:	5afd                	li	s5,-1
    5564:	a83d                	j	55a2 <malloc+0x92>
    5566:	f426                	sd	s1,40(sp)
    5568:	e852                	sd	s4,16(sp)
    556a:	e456                	sd	s5,8(sp)
    556c:	e05a                	sd	s6,0(sp)
    base.s.ptr = freep = prevp = &base;
    556e:	00009797          	auipc	a5,0x9
    5572:	74a78793          	addi	a5,a5,1866 # ecb8 <base>
    5576:	00003717          	auipc	a4,0x3
    557a:	f0f73d23          	sd	a5,-230(a4) # 8490 <freep>
    557e:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    5580:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    5584:	b7d1                	j	5548 <malloc+0x38>
        prevp->s.ptr = p->s.ptr;
    5586:	6398                	ld	a4,0(a5)
    5588:	e118                	sd	a4,0(a0)
    558a:	a899                	j	55e0 <malloc+0xd0>
  hp->s.size = nu;
    558c:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    5590:	0541                	addi	a0,a0,16
    5592:	ef9ff0ef          	jal	548a <free>
  return freep;
    5596:	6088                	ld	a0,0(s1)
      if((p = morecore(nunits)) == 0)
    5598:	c125                	beqz	a0,55f8 <malloc+0xe8>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    559a:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    559c:	4798                	lw	a4,8(a5)
    559e:	03277163          	bgeu	a4,s2,55c0 <malloc+0xb0>
    if(p == freep)
    55a2:	6098                	ld	a4,0(s1)
    55a4:	853e                	mv	a0,a5
    55a6:	fef71ae3          	bne	a4,a5,559a <malloc+0x8a>
  p = sbrk(nu * sizeof(Header));
    55aa:	8552                	mv	a0,s4
    55ac:	a0bff0ef          	jal	4fb6 <sbrk>
  if(p == SBRK_ERROR)
    55b0:	fd551ee3          	bne	a0,s5,558c <malloc+0x7c>
        return 0;
    55b4:	4501                	li	a0,0
    55b6:	74a2                	ld	s1,40(sp)
    55b8:	6a42                	ld	s4,16(sp)
    55ba:	6aa2                	ld	s5,8(sp)
    55bc:	6b02                	ld	s6,0(sp)
    55be:	a03d                	j	55ec <malloc+0xdc>
    55c0:	74a2                	ld	s1,40(sp)
    55c2:	6a42                	ld	s4,16(sp)
    55c4:	6aa2                	ld	s5,8(sp)
    55c6:	6b02                	ld	s6,0(sp)
      if(p->s.size == nunits)
    55c8:	fae90fe3          	beq	s2,a4,5586 <malloc+0x76>
        p->s.size -= nunits;
    55cc:	4137073b          	subw	a4,a4,s3
    55d0:	c798                	sw	a4,8(a5)
        p += p->s.size;
    55d2:	02071693          	slli	a3,a4,0x20
    55d6:	01c6d713          	srli	a4,a3,0x1c
    55da:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    55dc:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    55e0:	00003717          	auipc	a4,0x3
    55e4:	eaa73823          	sd	a0,-336(a4) # 8490 <freep>
      return (void*)(p + 1);
    55e8:	01078513          	addi	a0,a5,16
  }
}
    55ec:	70e2                	ld	ra,56(sp)
    55ee:	7442                	ld	s0,48(sp)
    55f0:	7902                	ld	s2,32(sp)
    55f2:	69e2                	ld	s3,24(sp)
    55f4:	6121                	addi	sp,sp,64
    55f6:	8082                	ret
    55f8:	74a2                	ld	s1,40(sp)
    55fa:	6a42                	ld	s4,16(sp)
    55fc:	6aa2                	ld	s5,8(sp)
    55fe:	6b02                	ld	s6,0(sp)
    5600:	b7f5                	j	55ec <malloc+0xdc>

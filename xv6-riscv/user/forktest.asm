...
forktest(void)
{
  ...
  34:	42850513          	addi	a0,a0,1064 # 458 <check_deadlock+0xe>
  ...
  56:	45650513          	addi	a0,a0,1110 # 4a8 <check_deadlock+0x5e>
  ...
  6c:	40050513          	addi	a0,a0,1024 # 468 <check_deadlock+0x1e>
  ...
  7e:	40650513          	addi	a0,a0,1030 # 480 <check_deadlock+0x36>
  ...
  ae:	3ee50513          	addi	a0,a0,1006 # 498 <check_deadlock+0x4e>
...
000000000000044a <check_deadlock>:

...
forktest(void)
{
  ...
  36:	40650513          	addi	a0,a0,1030 # 438 <check_deadlock+0xe>
  ...
  58:	43450513          	addi	a0,a0,1076 # 488 <check_deadlock+0x5e>
  ...
  6e:	3de50513          	addi	a0,a0,990 # 448 <check_deadlock+0x1e>
  ...
  80:	3e450513          	addi	a0,a0,996 # 460 <check_deadlock+0x36>
  ...
  b0:	3cc50513          	addi	a0,a0,972 # 478 <check_deadlock+0x4e>
...
000000000000042a <check_deadlock>:

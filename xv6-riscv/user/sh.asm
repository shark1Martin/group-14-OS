...
getcmd(char *buf, int nbuf)
{
  ...
  write(2, "$ ", 2);
      ...
      16:	28e58593          	addi	a1,a1,654 # 12a0 <malloc+0xf4>
      1a:	8532                	mv	a0,a2
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      58:	25c58593          	addi	a1,a1,604 # 12b0 <malloc+0x104>
      5c:	4509                	li	a0,2
      5e:	06c010ef          	jal	10ca <fprintf>
  exit(1);
      62:	4505                	li	a0,1
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      86:	23650513          	addi	a0,a0,566 # 12b8 <malloc+0x10c>
...
000000000000008e <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      ae:	30e70713          	addi	a4,a4,782 # 13b8 <malloc+0x20c>
    ...
    panic("runcmd");
      ...
      c6:	1fe50513          	addi	a0,a0,510 # 12c0 <malloc+0x114>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
      ...
      e0:	1ec58593          	addi	a1,a1,492 # 12c8 <malloc+0x11c>
      e4:	4509                	li	a0,2
      e6:	7e5000ef          	jal	10ca <fprintf>
  exit(0);
      ea:	4501                	li	a0,0
    ...
    runcmd(rcmd->cmd);
     ...
     114:	1c858593          	addi	a1,a1,456 # 12d8 <malloc+0x12c>
     118:	4509                	li	a0,2
     11a:	7b1000ef          	jal	10ca <fprintf>
      exit(1);
     11e:	4505                	li	a0,1
    ...
    if(fork1() == 0){
     ...
     176:	17650513          	addi	a0,a0,374 # 12e8 <malloc+0x13c>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     4d0:	e44b0b13          	addi	s6,s6,-444 # 1310 <malloc+0x164>
  ...
  while(peek(ps, es, "<>")){
     ...
     4e6:	e0e50513          	addi	a0,a0,-498 # 12f0 <malloc+0x144>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     5a6:	d7660613          	addi	a2,a2,-650 # 1318 <malloc+0x16c>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     5da:	d62b0b13          	addi	s6,s6,-670 # 1338 <malloc+0x18c>
  ...
  return ret;
     ...
     60c:	d1850513          	addi	a0,a0,-744 # 1320 <malloc+0x174>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     65a:	cd250513          	addi	a0,a0,-814 # 1328 <malloc+0x17c>
...
0000000000000682 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     6a2:	ca260613          	addi	a2,a2,-862 # 1340 <malloc+0x194>
     6a6:	85a6                	mv	a1,s1
     6a8:	854a                	mv	a0,s2
...
00000000000006e2 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     700:	c4ca0a13          	addi	s4,s4,-948 # 1348 <malloc+0x19c>
  ...
  if(peek(ps, es, ";")){
     ...
     72a:	c2a60613          	addi	a2,a2,-982 # 1350 <malloc+0x1a4>
     72e:	85ce                	mv	a1,s3
     730:	854a                	mv	a0,s2
...
000000000000076a <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     780:	b9c60613          	addi	a2,a2,-1124 # 1318 <malloc+0x16c>
  ...
  if(!peek(ps, es, ")"))
     ...
     7a4:	bc860613          	addi	a2,a2,-1080 # 1368 <malloc+0x1bc>
     7a8:	85ca                	mv	a1,s2
     7aa:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     7da:	b8250513          	addi	a0,a0,-1150 # 1358 <malloc+0x1ac>
     7de:	86dff0ef          	jal	4a <panic>
    panic("syntax - missing )");
     7e2:	00001517          	auipc	a0,0x1
     7e6:	b8e50513          	addi	a0,a0,-1138 # 1370 <malloc+0x1c4>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     80e:	bc670713          	addi	a4,a4,-1082 # 13d0 <malloc+0x224>
...
000000000000086e <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     89e:	a0e60613          	addi	a2,a2,-1522 # 12a8 <malloc+0xfc>
     8a2:	85a6                	mv	a1,s1
     8a4:	854a                	mv	a0,s2
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     8cc:	ac058593          	addi	a1,a1,-1344 # 1388 <malloc+0x1dc>
     8d0:	4509                	li	a0,2
     8d2:	7f8000ef          	jal	10ca <fprintf>
    panic("syntax");
     8d6:	00001517          	auipc	a0,0x1
     8da:	a4a50513          	addi	a0,a0,-1462 # 1320 <malloc+0x174>
...
00000000000008e2 <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     8fc:	aa090913          	addi	s2,s2,-1376 # 1398 <malloc+0x1ec>
     900:	85a6                	mv	a1,s1
     902:	854a                	mv	a0,s2
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(cmd[0] == 'c' && cmd[1] == 'd' && cmd[2] == ' '){
     ...
     9b4:	9f058593          	addi	a1,a1,-1552 # 13a0 <malloc+0x1f4>
     9b8:	4509                	li	a0,2
     9ba:	710000ef          	jal	10ca <fprintf>
...
0000000000000d46 <check_deadlock>:
...
putc(int fd, char c)
{
     ...
     d56:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
     d5a:	4605                	li	a2,1
     d5c:	fef40593          	addi	a1,s0,-17
     d60:	f47ff0ef          	jal	ca6 <write>
}
...
0000000000000d6c <printint>:

static void
printint(int fd, long long xx, int base, int sgn)
{
     d6c:	715d                	addi	sp,sp,-80
     d6e:	e486                	sd	ra,72(sp)
     d70:	e0a2                	sd	s0,64(sp)
     d72:	f84a                	sd	s2,48(sp)
     d74:	f44e                	sd	s3,40(sp)
  ...
  neg = 0;
  if(sgn && xx < 0){
     d7a:	c6d1                	beqz	a3,e06 <printint+0x9a>
     d7c:	0805d563          	bgez	a1,e06 <printint+0x9a>
    neg = 1;
    x = -xx;
  ...
  do{
    buf[i++] = digits[x % base];
     d8e:	00000817          	auipc	a6,0x0
     d92:	65a80813          	addi	a6,a6,1626 # 13e8 <digits>
     d96:	88ba                	mv	a7,a4
     d98:	0017051b          	addiw	a0,a4,1
     d9c:	872a                	mv	a4,a0
     d9e:	02c5f7b3          	remu	a5,a1,a2
     da2:	97c2                	add	a5,a5,a6
     da4:	0007c783          	lbu	a5,0(a5)
     da8:	00f68023          	sb	a5,0(a3)
  }while((x /= base) != 0);
     dac:	87ae                	mv	a5,a1
     dae:	02c5d5b3          	divu	a1,a1,a2
     db2:	0685                	addi	a3,a3,1
     db4:	fec7f1e3          	bgeu	a5,a2,d96 <printint+0x2a>
  if(neg)
     db8:	00030c63          	beqz	t1,dd0 <printint+0x64>
    buf[i++] = '-';
     dbc:	fd050793          	addi	a5,a0,-48
     dc0:	00878533          	add	a0,a5,s0
     dc4:	02d00793          	li	a5,45
     dc8:	fef50423          	sb	a5,-24(a0)
     dcc:	0028871b          	addiw	a4,a7,2

  while(--i >= 0)
     dd0:	02e05563          	blez	a4,dfa <printint+0x8e>
     dd4:	fc26                	sd	s1,56(sp)
     dd6:	377d                	addiw	a4,a4,-1
     dd8:	00e984b3          	add	s1,s3,a4
     ddc:	19fd                	addi	s3,s3,-1
     dde:	99ba                	add	s3,s3,a4
     de0:	1702                	slli	a4,a4,0x20
     de2:	9301                	srli	a4,a4,0x20
     de4:	40e989b3          	sub	s3,s3,a4
    putc(fd, buf[i]);
     de8:	0004c583          	lbu	a1,0(s1)
     dec:	854a                	mv	a0,s2
     dee:	f61ff0ef          	jal	d4e <putc>
  while(--i >= 0)
     df2:	14fd                	addi	s1,s1,-1
     df4:	ff349ae3          	bne	s1,s3,de8 <printint+0x7c>
     df8:	74e2                	ld	s1,56(sp)
}
     dfa:	60a6                	ld	ra,72(sp)
     dfc:	6406                	ld	s0,64(sp)
     dfe:	7942                	ld	s2,48(sp)
     e00:	79a2                	ld	s3,40(sp)
     e02:	6161                	addi	sp,sp,80
     e04:	8082                	ret
  neg = 0;
     e06:	4301                	li	t1,0
     e08:	bfbd                	j	d86 <printint+0x1a>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
  for(i = 0; fmt[i]; i++){
     e14:	0005c483          	lbu	s1,0(a1)
     e18:	22048363          	beqz	s1,103e <vprintf+0x234>
     e1c:	e0ca                	sd	s2,64(sp)
  ...
  for(i = 0; fmt[i]; i++){
     ...
     e36:	02500a93          	li	s5,37
      c1 = c2 = 0;
      if(c0) c1 = fmt[i+1] & 0xff;
      if(c1) c2 = fmt[i+2] & 0xff;
      if(c0 == 'd'){
     e3a:	06400c13          	li	s8,100
     e3e:	a00d                	j	e60 <vprintf+0x56>
        putc(fd, c0);
     e40:	85a6                	mv	a1,s1
     e42:	855a                	mv	a0,s6
     e44:	f0bff0ef          	jal	d4e <putc>
     e48:	a019                	j	e4e <vprintf+0x44>
    } else if(state == '%'){
     e4a:	03598363          	beq	s3,s5,e70 <vprintf+0x66>
  for(i = 0; fmt[i]; i++){
     e4e:	0019079b          	addiw	a5,s2,1
     e52:	893e                	mv	s2,a5
     e54:	873e                	mv	a4,a5
     e56:	97d2                	add	a5,a5,s4
     e58:	0007c483          	lbu	s1,0(a5)
     e5c:	1c048a63          	beqz	s1,1030 <vprintf+0x226>
    c0 = fmt[i] & 0xff;
     e60:	0004879b          	sext.w	a5,s1
    if(state == 0){
     e64:	fe0993e3          	bnez	s3,e4a <vprintf+0x40>
      if(c0 == '%'){
     e68:	fd579ce3          	bne	a5,s5,e40 <vprintf+0x36>
        state = '%';
     e6c:	89be                	mv	s3,a5
     e6e:	b7c5                	j	e4e <vprintf+0x44>
      if(c0) c1 = fmt[i+1] & 0xff;
     e70:	00ea06b3          	add	a3,s4,a4
     e74:	0016c603          	lbu	a2,1(a3)
      if(c1) c2 = fmt[i+2] & 0xff;
     e78:	1c060863          	beqz	a2,1048 <vprintf+0x23e>
      if(c0 == 'd'){
     e7c:	03878763          	beq	a5,s8,eaa <vprintf+0xa0>
        printint(fd, va_arg(ap, int), 10, 1);
      } else if(c0 == 'l' && c1 == 'd'){
     e80:	f9478693          	addi	a3,a5,-108
     e84:	0016b693          	seqz	a3,a3
     e88:	f9c60593          	addi	a1,a2,-100
     e8c:	e99d                	bnez	a1,ec2 <vprintf+0xb8>
     e8e:	ca95                	beqz	a3,ec2 <vprintf+0xb8>
     ...
     e9c:	855a                	mv	a0,s6
     e9e:	ecfff0ef          	jal	d6c <printint>
        i += 1;
     ea2:	2905                	addiw	s2,s2,1
        printint(fd, va_arg(ap, uint64), 10, 1);
     ea4:	8ba6                	mv	s7,s1
     ...
     eb6:	855a                	mv	a0,s6
     eb8:	eb5ff0ef          	jal	d6c <printint>
     ebc:	8ba6                	mv	s7,s1
      state = 0;
     ebe:	4981                	li	s3,0
     ec0:	b779                	j	e4e <vprintf+0x44>
      if(c1) c2 = fmt[i+2] & 0xff;
     ec2:	9752                	add	a4,a4,s4
     ec4:	00274583          	lbu	a1,2(a4)
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
     ec8:	f9460713          	addi	a4,a2,-108
     ecc:	00173713          	seqz	a4,a4
     ed0:	8f75                	and	a4,a4,a3
     ed2:	f9c58513          	addi	a0,a1,-100
     ed6:	18051363          	bnez	a0,105c <vprintf+0x252>
     eda:	18070163          	beqz	a4,105c <vprintf+0x252>
        printint(fd, va_arg(ap, uint64), 10, 1);
     ...
     f04:	855a                	mv	a0,s6
     f06:	e67ff0ef          	jal	d6c <printint>
     f0a:	8ba6                	mv	s7,s1
      state = 0;
     f0c:	4981                	li	s3,0
     f0e:	b781                	j	e4e <vprintf+0x44>
     ...
     f50:	855a                	mv	a0,s6
     f52:	e1bff0ef          	jal	d6c <printint>
     f56:	8ba6                	mv	s7,s1
      state = 0;
     f58:	4981                	li	s3,0
     f5a:	bdd5                	j	e4e <vprintf+0x44>
     ...
     f68:	855a                	mv	a0,s6
     f6a:	e03ff0ef          	jal	d6c <printint>
        i += 1;
     f6e:	2905                	addiw	s2,s2,1
        printint(fd, va_arg(ap, uint64), 16, 0);
     f70:	8ba6                	mv	s7,s1
      state = 0;
     f72:	4981                	li	s3,0
     f74:	bde9                	j	e4e <vprintf+0x44>
        printint(fd, va_arg(ap, uint64), 16, 0);
     ...
     f82:	855a                	mv	a0,s6
     f84:	de9ff0ef          	jal	d6c <printint>
        i += 2;
     f88:	2909                	addiw	s2,s2,2
        printint(fd, va_arg(ap, uint64), 16, 0);
     f8a:	8ba6                	mv	s7,s1
      state = 0;
     f8c:	4981                	li	s3,0
        i += 2;
     f8e:	b5c1                	j	e4e <vprintf+0x44>
     f90:	e466                	sd	s9,8(sp)
        printptr(fd, va_arg(ap, uint64));
     f92:	008b8793          	addi	a5,s7,8
     f96:	8cbe                	mv	s9,a5
     f98:	000bb983          	ld	s3,0(s7)
  putc(fd, '0');
     f9c:	03000593          	li	a1,48
     fa0:	855a                	mv	a0,s6
     fa2:	dadff0ef          	jal	d4e <putc>
  putc(fd, 'x');
     fa6:	07800593          	li	a1,120
     faa:	855a                	mv	a0,s6
     fac:	da3ff0ef          	jal	d4e <putc>
     fb0:	44c1                	li	s1,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     fb2:	00000b97          	auipc	s7,0x0
     fb6:	436b8b93          	addi	s7,s7,1078 # 13e8 <digits>
     fba:	03c9d793          	srli	a5,s3,0x3c
     fbe:	97de                	add	a5,a5,s7
     fc0:	0007c583          	lbu	a1,0(a5)
     fc4:	855a                	mv	a0,s6
     fc6:	d89ff0ef          	jal	d4e <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
     fca:	0992                	slli	s3,s3,0x4
     fcc:	34fd                	addiw	s1,s1,-1
     fce:	f4f5                	bnez	s1,fba <vprintf+0x1b0>
        printptr(fd, va_arg(ap, uint64));
     fd0:	8be6                	mv	s7,s9
      state = 0;
     fd2:	4981                	li	s3,0
     fd4:	6ca2                	ld	s9,8(sp)
     fd6:	bda5                	j	e4e <vprintf+0x44>
        putc(fd, va_arg(ap, uint32));
     fd8:	008b8493          	addi	s1,s7,8
     fdc:	000bc583          	lbu	a1,0(s7)
     fe0:	855a                	mv	a0,s6
     fe2:	d6dff0ef          	jal	d4e <putc>
     fe6:	8ba6                	mv	s7,s1
      state = 0;
     fe8:	4981                	li	s3,0
     fea:	b595                	j	e4e <vprintf+0x44>
        if((s = va_arg(ap, char*)) == 0)
     fec:	008b8993          	addi	s3,s7,8
     ff0:	000bb483          	ld	s1,0(s7)
     ff4:	cc91                	beqz	s1,1010 <vprintf+0x206>
        for(; *s; s++)
     ff6:	0004c583          	lbu	a1,0(s1)
     ffa:	c985                	beqz	a1,102a <vprintf+0x220>
          putc(fd, *s);
     ffc:	855a                	mv	a0,s6
     ffe:	d51ff0ef          	jal	d4e <putc>
        for(; *s; s++)
    1002:	0485                	addi	s1,s1,1
    1004:	0004c583          	lbu	a1,0(s1)
    1008:	f9f5                	bnez	a1,ffc <vprintf+0x1f2>
        if((s = va_arg(ap, char*)) == 0)
    100a:	8bce                	mv	s7,s3
      state = 0;
    100c:	4981                	li	s3,0
    100e:	b581                	j	e4e <vprintf+0x44>
          s = "(null)";
    1010:	00000497          	auipc	s1,0x0
    1014:	3a048493          	addi	s1,s1,928 # 13b0 <malloc+0x204>
        for(; *s; s++)
    1018:	02800593          	li	a1,40
    101c:	b7c5                	j	ffc <vprintf+0x1f2>
        putc(fd, '%');
    101e:	85be                	mv	a1,a5
    1020:	855a                	mv	a0,s6
    1022:	d2dff0ef          	jal	d4e <putc>
      state = 0;
    1026:	4981                	li	s3,0
    1028:	b51d                	j	e4e <vprintf+0x44>
        if((s = va_arg(ap, char*)) == 0)
    102a:	8bce                	mv	s7,s3
      state = 0;
    102c:	4981                	li	s3,0
    102e:	b505                	j	e4e <vprintf+0x44>
    ...
    103e:	60e6                	ld	ra,88(sp)
    1040:	6446                	ld	s0,80(sp)
    1042:	64a6                	ld	s1,72(sp)
    1044:	6125                	addi	sp,sp,96
    1046:	8082                	ret
      if(c0 == 'd'){
    1048:	06400713          	li	a4,100
    104c:	e4e78fe3          	beq	a5,a4,eaa <vprintf+0xa0>
      } else if(c0 == 'l' && c1 == 'd'){
    1050:	f9478693          	addi	a3,a5,-108
    1054:	0016b693          	seqz	a3,a3
      c1 = c2 = 0;
    1058:	85b2                	mv	a1,a2
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
    105a:	4701                	li	a4,0
      } else if(c0 == 'u'){
    105c:	07500513          	li	a0,117
    1060:	e8a78ce3          	beq	a5,a0,ef8 <vprintf+0xee>
      } else if(c0 == 'l' && c1 == 'u'){
    1064:	f8b60513          	addi	a0,a2,-117
    1068:	e119                	bnez	a0,106e <vprintf+0x264>
    106a:	ea0693e3          	bnez	a3,f10 <vprintf+0x106>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
    106e:	f8b58513          	addi	a0,a1,-117
    1072:	e119                	bnez	a0,1078 <vprintf+0x26e>
    1074:	ea071be3          	bnez	a4,f2a <vprintf+0x120>
      } else if(c0 == 'x'){
    1078:	07800513          	li	a0,120
    107c:	eca784e3          	beq	a5,a0,f44 <vprintf+0x13a>
      } else if(c0 == 'l' && c1 == 'x'){
    1080:	f8860613          	addi	a2,a2,-120
    1084:	e219                	bnez	a2,108a <vprintf+0x280>
    1086:	ec069be3          	bnez	a3,f5c <vprintf+0x152>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'x'){
    108a:	f8858593          	addi	a1,a1,-120
    108e:	e199                	bnez	a1,1094 <vprintf+0x28a>
    1090:	ee0713e3          	bnez	a4,f76 <vprintf+0x16c>
      } else if(c0 == 'p'){
    1094:	07000713          	li	a4,112
    1098:	eee78ce3          	beq	a5,a4,f90 <vprintf+0x186>
      } else if(c0 == 'c'){
    109c:	06300713          	li	a4,99
    10a0:	f2e78ce3          	beq	a5,a4,fd8 <vprintf+0x1ce>
      } else if(c0 == 's'){
    10a4:	07300713          	li	a4,115
    10a8:	f4e782e3          	beq	a5,a4,fec <vprintf+0x1e2>
      } else if(c0 == '%'){
    10ac:	02500713          	li	a4,37
    10b0:	f6e787e3          	beq	a5,a4,101e <vprintf+0x214>
        putc(fd, '%');
    10b4:	02500593          	li	a1,37
    10b8:	855a                	mv	a0,s6
    10ba:	c95ff0ef          	jal	d4e <putc>
        putc(fd, c0);
    10be:	85a6                	mv	a1,s1
    10c0:	855a                	mv	a0,s6
    10c2:	c8dff0ef          	jal	d4e <putc>
      state = 0;
    10c6:	4981                	li	s3,0
    10c8:	b359                	j	e4e <vprintf+0x44>

00000000000010ca <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    10ca:	715d                	addi	sp,sp,-80
    10cc:	ec06                	sd	ra,24(sp)
    10ce:	e822                	sd	s0,16(sp)
    10d0:	1000                	addi	s0,sp,32
    10d2:	e010                	sd	a2,0(s0)
    10d4:	e414                	sd	a3,8(s0)
    10d6:	e818                	sd	a4,16(s0)
    10d8:	ec1c                	sd	a5,24(s0)
    10da:	03043023          	sd	a6,32(s0)
    10de:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    10e2:	8622                	mv	a2,s0
    10e4:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    10e8:	d23ff0ef          	jal	e0a <vprintf>
}
    10ec:	60e2                	ld	ra,24(sp)
    10ee:	6442                	ld	s0,16(sp)
    10f0:	6161                	addi	sp,sp,80
    10f2:	8082                	ret

00000000000010f4 <printf>:
...
printf(const char *fmt, ...)
{
    ...
    10f8:	e822                	sd	s0,16(sp)
    10fa:	1000                	addi	s0,sp,32
    10fc:	e40c                	sd	a1,8(s0)
    10fe:	e810                	sd	a2,16(s0)
    1100:	ec14                	sd	a3,24(s0)
    1102:	f018                	sd	a4,32(s0)
    1104:	f41c                	sd	a5,40(s0)
    1106:	03043823          	sd	a6,48(s0)
    110a:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    110e:	00840613          	addi	a2,s0,8
    1112:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    1116:	85aa                	mv	a1,a0
    1118:	4505                	li	a0,1
    111a:	cf1ff0ef          	jal	e0a <vprintf>
}
    111e:	60e2                	ld	ra,24(sp)
    1120:	6442                	ld	s0,16(sp)
    1122:	6125                	addi	sp,sp,96
    1124:	8082                	ret

0000000000001126 <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
    ...
    112a:	e022                	sd	s0,0(sp)
    112c:	0800                	addi	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    112e:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1132:	00001797          	auipc	a5,0x1
    1136:	ede7b783          	ld	a5,-290(a5) # 2010 <freep>
    113a:	a039                	j	1148 <free+0x22>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    113c:	6398                	ld	a4,0(a5)
    113e:	00e7e463          	bltu	a5,a4,1146 <free+0x20>
    1142:	00e6ea63          	bltu	a3,a4,1156 <free+0x30>
{
    1146:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1148:	fed7fae3          	bgeu	a5,a3,113c <free+0x16>
    114c:	6398                	ld	a4,0(a5)
    114e:	00e6e463          	bltu	a3,a4,1156 <free+0x30>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    1152:	fee7eae3          	bltu	a5,a4,1146 <free+0x20>
      break;
  if(bp + bp->s.size == p->s.ptr){
    1156:	ff852583          	lw	a1,-8(a0)
    115a:	6390                	ld	a2,0(a5)
    115c:	02059813          	slli	a6,a1,0x20
    1160:	01c85713          	srli	a4,a6,0x1c
    1164:	9736                	add	a4,a4,a3
    1166:	02e60563          	beq	a2,a4,1190 <free+0x6a>
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
    116a:	fec53823          	sd	a2,-16(a0)
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    116e:	4790                	lw	a2,8(a5)
    1170:	02061593          	slli	a1,a2,0x20
    1174:	01c5d713          	srli	a4,a1,0x1c
    1178:	973e                	add	a4,a4,a5
    117a:	02e68263          	beq	a3,a4,119e <free+0x78>
    p->s.size += bp->s.size;
    p->s.ptr = bp->s.ptr;
    117e:	e394                	sd	a3,0(a5)
  } else
    p->s.ptr = bp;
  freep = p;
    ...
    1188:	60a2                	ld	ra,8(sp)
    118a:	6402                	ld	s0,0(sp)
    118c:	0141                	addi	sp,sp,16
    118e:	8082                	ret
    bp->s.size += p->s.ptr->s.size;
    1190:	4618                	lw	a4,8(a2)
    1192:	9f2d                	addw	a4,a4,a1
    1194:	fee52c23          	sw	a4,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    1198:	6398                	ld	a4,0(a5)
    119a:	6310                	ld	a2,0(a4)
    119c:	b7f9                	j	116a <free+0x44>
    p->s.size += bp->s.size;
    119e:	ff852703          	lw	a4,-8(a0)
    11a2:	9f31                	addw	a4,a4,a2
    11a4:	c798                	sw	a4,8(a5)
    p->s.ptr = bp->s.ptr;
    11a6:	ff053683          	ld	a3,-16(a0)
    11aa:	bfd1                	j	117e <free+0x58>

00000000000011ac <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
    11ac:	7139                	addi	sp,sp,-64
    11ae:	fc06                	sd	ra,56(sp)
    11b0:	f822                	sd	s0,48(sp)
    11b2:	f04a                	sd	s2,32(sp)
    11b4:	ec4e                	sd	s3,24(sp)
    11b6:	0080                	addi	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    11b8:	02051993          	slli	s3,a0,0x20
    11bc:	0209d993          	srli	s3,s3,0x20
    11c0:	09bd                	addi	s3,s3,15
    11c2:	0049d993          	srli	s3,s3,0x4
    11c6:	2985                	addiw	s3,s3,1
    11c8:	894e                	mv	s2,s3
  if((prevp = freep) == 0){
    11ca:	00001517          	auipc	a0,0x1
    11ce:	e4653503          	ld	a0,-442(a0) # 2010 <freep>
    11d2:	c905                	beqz	a0,1202 <malloc+0x56>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    11d8:	09377663          	bgeu	a4,s3,1264 <malloc+0xb8>
    11dc:	f426                	sd	s1,40(sp)
    11de:	e852                	sd	s4,16(sp)
    11e0:	e456                	sd	s5,8(sp)
    11e2:	e05a                	sd	s6,0(sp)
  if(nu < 4096)
    11e4:	8a4e                	mv	s4,s3
    11e6:	6705                	lui	a4,0x1
    11e8:	00e9f363          	bgeu	s3,a4,11ee <malloc+0x42>
    11ec:	6a05                	lui	s4,0x1
    11ee:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    11f2:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    11f6:	00001497          	auipc	s1,0x1
    11fa:	e1a48493          	addi	s1,s1,-486 # 2010 <freep>
  if(p == SBRK_ERROR)
    11fe:	5afd                	li	s5,-1
    1200:	a83d                	j	123e <malloc+0x92>
    ...
    120e:	e7e78793          	addi	a5,a5,-386 # 2088 <base>
    1212:	00001717          	auipc	a4,0x1
    1216:	def73f23          	sd	a5,-514(a4) # 2010 <freep>
    121a:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    121c:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    1220:	b7d1                	j	11e4 <malloc+0x38>
        prevp->s.ptr = p->s.ptr;
    1222:	6398                	ld	a4,0(a5)
    1224:	e118                	sd	a4,0(a0)
    1226:	a899                	j	127c <malloc+0xd0>
  hp->s.size = nu;
    1228:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    122c:	0541                	addi	a0,a0,16
    122e:	ef9ff0ef          	jal	1126 <free>
  return freep;
    1232:	6088                	ld	a0,0(s1)
      if((p = morecore(nunits)) == 0)
    1234:	c125                	beqz	a0,1294 <malloc+0xe8>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1236:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    1238:	4798                	lw	a4,8(a5)
    123a:	03277163          	bgeu	a4,s2,125c <malloc+0xb0>
    if(p == freep)
    123e:	6098                	ld	a4,0(s1)
    1240:	853e                	mv	a0,a5
    1242:	fef71ae3          	bne	a4,a5,1236 <malloc+0x8a>
  p = sbrk(nu * sizeof(Header));
    1246:	8552                	mv	a0,s4
    1248:	a0bff0ef          	jal	c52 <sbrk>
  if(p == SBRK_ERROR)
    124c:	fd551ee3          	bne	a0,s5,1228 <malloc+0x7c>
        return 0;
    1250:	4501                	li	a0,0
    1252:	74a2                	ld	s1,40(sp)
    1254:	6a42                	ld	s4,16(sp)
    1256:	6aa2                	ld	s5,8(sp)
    1258:	6b02                	ld	s6,0(sp)
    125a:	a03d                	j	1288 <malloc+0xdc>
    125c:	74a2                	ld	s1,40(sp)
    125e:	6a42                	ld	s4,16(sp)
    1260:	6aa2                	ld	s5,8(sp)
    1262:	6b02                	ld	s6,0(sp)
      if(p->s.size == nunits)
    1264:	fae90fe3          	beq	s2,a4,1222 <malloc+0x76>
        p->s.size -= nunits;
    1268:	4137073b          	subw	a4,a4,s3
    126c:	c798                	sw	a4,8(a5)
        p += p->s.size;
    126e:	02071693          	slli	a3,a4,0x20
    1272:	01c6d713          	srli	a4,a3,0x1c
    1276:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    1278:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    127c:	00001717          	auipc	a4,0x1
    1280:	d8a73a23          	sd	a0,-620(a4) # 2010 <freep>
      return (void*)(p + 1);
    1284:	01078513          	addi	a0,a5,16
  }
}
    1288:	70e2                	ld	ra,56(sp)
    128a:	7442                	ld	s0,48(sp)
    128c:	7902                	ld	s2,32(sp)
    128e:	69e2                	ld	s3,24(sp)
    1290:	6121                	addi	sp,sp,64
    1292:	8082                	ret
    1294:	74a2                	ld	s1,40(sp)
    1296:	6a42                	ld	s4,16(sp)
    1298:	6aa2                	ld	s5,8(sp)
    129a:	6b02                	ld	s6,0(sp)
    129c:	b7f5                	j	1288 <malloc+0xdc>
